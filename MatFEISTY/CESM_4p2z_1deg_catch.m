...
model = '4P2Z';
[fname,simname] = sub_fname_run_1meso(param,model);
...
%! Initialize
init_sim = simname;
load(['/Volumes/petrik-lab/Feisty/NC/CESM_MAPP/',init_sim,'/',model,'/Last_mo_',model,'_spin_' init_sim '.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+1957)
    load(['/Volumes/petrik-lab/Feisty/GCM_DATA/CESM/4P2Z/Data_cesm_4p2z_daily_',ti,'.mat'],'ESM')
