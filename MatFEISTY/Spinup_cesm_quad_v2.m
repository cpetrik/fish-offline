...
%Uses calc quad mort instead of tot mort
%Calc quad mort before splitting into Lzoo
function Spinup_cesm_quad_v2()
...
load('/Volumes/MIP/GCM_DATA/CESM/FOSI/Data_cesm_fosi_quad_v2.3_daily_1.mat','ESM');
MNT = 0;
%! Run model 
