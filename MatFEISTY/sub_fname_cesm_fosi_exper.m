...
elseif (param.MFsel~=param.LPsel)
    fname = ['/Volumes/petrik-lab/Feisty/NC/CESM_MAPP/',simname, '/FOSI_',exper,'fish_F',tF(2:end),'_P',tP(2:end),'_D',tD(2:end)];
else
    fname  = ['/Volumes/petrik-lab/Feisty/NC/CESM_MAPP/',simname, '/FOSI_',exper,sel,'_fish',tfish(2:end)];  
end
