...
load(['/Volumes/petrik-lab/GCM_DATA/CESM/FOSI/Data_cesm_fosi_v7_daily_climtol_food_1yr.mat'],'CESM');
...
for n = 1:yrs % years
    for YR = 1:5
        ...
        % Use climatology of food-related forcings (zoop, det)
        ESM.Zm = CESM.Zm;
        ESM.dZm = CESM.dZm;
        ESM.det = CESM.det;
