%============== INITIAL CONDITIONS =============%
function [Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT] = sub_init_fish_testcase(ID,DAYS)

% Initialize all variables including biomass for spinup
% Starts at very low biomass
