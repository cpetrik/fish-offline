...
%%
writetable(Ftab1,[spath,'USLMEs_regress_driver_div2SD_maxcoef_Fnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'USLMEs_regress_driver_div2SD_maxcoef_Pnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'USLMEs_regress_driver_div2SD_maxcoef_Dnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'USLMEs_regress_driver_div2SD_maxcoef_Anu.csv'],...
    'Delimiter',',','WriteRowNames',true);
