...
fcoef <- read.csv(paste0(datar,"LME_corr_maxlag_driver_catch_F.csv"),sep=",",header = T,stringsAsFactors = F)
pcoef <- read.csv(paste0(datar,"LME_corr_maxlag_driver_catch_P.csv"),sep=",",header = T,stringsAsFactors = F)
dcoef <- read.csv(paste0(datar,"LME_corr_maxlag_driver_catch_D.csv"),sep=",",header = T,stringsAsFactors = F)
acoef <- read.csv(paste0(datar,"LME_corr_maxlag_driver_catch_A.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,"heatmap_LME_driver_catch_A_corr_coeffs_4clus.png"),    # create PNG for the heat map        
...
png(paste0(figp,"heatmap_LME_driver_catch_F_corr_coeffs_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"heatmap_LME_driver_catch_P_corr_coeffs_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"heatmap_LME_driver_catch_D_corr_coeffs_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
### Save clustering
write.table(acoef,paste0(datar,"LME_driver_catch_A_corr_coeffs_4cluster.csv"),sep=",",row.names=F)
write.table(fcoef,paste0(datar,"LME_driver_catch_F_corr_coeffs_4cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_driver_catch_P_corr_coeffs_5cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_driver_catch_D_corr_coeffs_5cluster.csv"),sep=",",row.names=F)
