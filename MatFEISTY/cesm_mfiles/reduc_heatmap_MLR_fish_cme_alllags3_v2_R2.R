...
png(paste0(figp,"reduc_heatmap_LME_F_cme_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_P_cme_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_D_cme_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
