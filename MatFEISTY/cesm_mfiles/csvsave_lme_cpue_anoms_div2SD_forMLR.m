...
load([cpath 'FishMIP_Phase3a_LME_CPUE_1961-2010_ann_mean_anoms.mat'],...
    'af','ap','ad','aall')
...
%%
writetable(Ftab1,[cpath,'LMEs_FishMIP_cpue_anoms_div2SD_F.csv'],...
    'Delimiter',',');
writetable(Ptab1,[cpath,'LMEs_FishMIP_cpue_anoms_div2SD_P.csv'],...
    'Delimiter',',');
writetable(Dtab1,[cpath,'LMEs_FishMIP_cpue_anoms_div2SD_D.csv'],...
    'Delimiter',',');
writetable(Atab1,[cpath,'LMEs_FishMIP_cpue_anoms_div2SD_A.csv'],...
    'Delimiter',',');
