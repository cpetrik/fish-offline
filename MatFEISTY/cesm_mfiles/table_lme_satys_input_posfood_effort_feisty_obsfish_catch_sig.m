...
otex = {'TP','TB','Det','ZmLoss','SST','Chl','Biom','Prod','Catch'};
...
oetex = {'TP','TB','Det','ZmLoss','SST','Chl','Biom','Prod','Catch','Effort'};
...
%%
writetable(TabA,[spath,'Num_LMEs_corr_catch_satyrs_driver_feisty_effort_maxcorr_posfood_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabF,[spath,'Num_LMEs_corr_catch_satyrs_driver_feisty_effort_maxcorr_posfood_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabP,[spath,'Num_LMEs_corr_catch_satyrs_driver_feisty_effort_maxcorr_posfood_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabD,[spath,'Num_LMEs_corr_catch_satyrs_driver_feisty_effort_maxcorr_posfood_D.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'Num_LMEs_corr_catch_satyrs_driver_feisty_effort_maxcorr_posfoods.mat'],...
    'matF','matP','matD','matA',...
