...
%%
writetable(Ftab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_D.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Btab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_B.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TPtab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_TP.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TBtab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_TB.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(POCtab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_POC.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(ZMtab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_ZM.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(ZLtab1,[spath,'USLMEs_regressDJF_climate_div2SD_maxcoef_ZL.csv'],...
    'Delimiter',',','WriteRowNames',true);
