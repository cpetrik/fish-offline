...
cfile = 'Dc_Lam700_enc70-b200_m400-b175-k086_c20-b250_D075_A050_sMZ080_mMZ040_nmort1_BE08_CC80_RE00100';
...
load([dpath 'Space_Means_4P2Z_1deg_' cfile '.mat'],'sf_sbio','sp_sbio','sd_sbio',...
...
%%
%save([dpath 'LME_',mod,cfile '.mat'],'lme_mbio','lme_sbio','-append');
save([dpath 'LME_',mod,cfile '.mat'],'lme_mbio','lme_sbio','lme_area');
