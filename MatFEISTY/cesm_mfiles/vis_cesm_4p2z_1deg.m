...
load([fpath 'Time_Means_4P2Z_1deg_' cfile '.mat']);
...
title('4P2Z 1deg')
stamp(mod)
print('-dpng',[ppath '4P2Z_1deg_',mod,'_all_sizes.png'])
...
title('4P2Z 1deg')
stamp(mod)
print('-dpng',[ppath '4P2Z_1deg_',mod,'_all_types.png'])
...
save([fpath 'Plot_Means_4P2Z_1deg_' cfile '.mat'],'F','P','D','B',...
...
title('4P2Z 1deg log10 mean benthic biomass (g m^-^2)')
stamp('')
print('-dpng',[ppath '4P2Z_1deg_',mod,'_global_BENT.png'])
...
stamp('')
print('-dpng',[ppath '4P2Z_1deg_',mod,'_global_All_subplot.png'])
...
stamp('')
print('-dpng',[ppath '4P2Z_1deg_',mod,'_global_ratios_subplot.png'])
...
%histogram(test2)        % 4p4z;    4p2z v1;    4p2z v2     4p2z v3  A=0.75
sum(test2)/length(test2) % = 4.70;              4.84;       4.42    3.25

%happens >=50% of year
test4=round(Cmz_stover5);
%histogram(test4)
sum(test4)/length(test4) % = 5.15;              5.34        4.90    3.73
...
print('-dpng',[ppath '4P2Z_1deg_',mod '_timeseries_zoop_overcon.png'])
...
% save([bpath '4P2Z_1deg_' mod '_ts_map_zoop_overcon.mat'],...
...
print('-dpng',[ppath '4P2Z_1deg_',mod '_global_zoop_overcon.png'])
