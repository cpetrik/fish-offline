% Plot coeffs of driver-cpue SLR
% For all 63 LMEs
...
load([spath,'LMEs_SLR_cpue_sat_driver_feisty_norec_maxR2s.mat'])
...
% CPUE of Lg Pel in LME 64 is 0, fix nans
Ptab(61,1) = 0;
Ptab(61,2) = 1;
Ptab(61,3) = 0;
Ptab(61,4) = 0;
...
print('-dpng',[ppath 'Bar_LMEs_cpue_sat_driver_feisty_SLR_maxR2s_allfish.png'])
...
% stamp('LR')
% 
% print('-dpng',[ppath 'Bar_LMEs_cpue_sat_driver_feisty_SLR_maxR2s_fntypes.png'])
