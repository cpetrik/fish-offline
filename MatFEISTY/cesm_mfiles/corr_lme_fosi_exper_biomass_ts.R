...
write.table(sigCHK,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_climate_corrs_CHK.csv"),sep=",",row.names=F)
write.table(sigEBS,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_climate_corrs_EBS.csv"),sep=",",row.names=F)
write.table(sigGAK,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_climate_corrs_GAK.csv"),sep=",",row.names=F)
write.table(sigCCE,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_climate_corrs_CCE.csv"),sep=",",row.names=F)
write.table(sigHI,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_climate_corrs_HI.csv"),sep=",",row.names=F)
write.table(sigGMX,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_climate_corrs_GMX.csv"),sep=",",row.names=F)
write.table(sigSE,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_climate_corrs_SE.csv"),sep=",",row.names=F)
write.table(sigNE,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_climate_corrs_NE.csv"),sep=",",row.names=F)
