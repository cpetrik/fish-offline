% Calc corr of catch with forcing, biomass, nu, recruit
...
%%
writetable(Atab1,[spath,'LMEs_corr_catch_sat_driver_feistyrec_maxcorr_A.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'LMEs_corr_catch_sat_driver_feistyrec_maxcorrs.mat'],...
    'LAtab','Atab1','lid');
