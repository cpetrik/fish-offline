...
png(paste0(figp,'Heatmaps_CCE_coef_select_climate_inputs_fish.png'), 
...
png(paste0(figp,'Heatmaps_EBS_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
png(paste0(figp,'Heatmaps_AI_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
plot_grid( i4,i5,i3,
           nrow = , ncol = 3)#, labels = "auto", label_size = 12, hjust = -4)
dev.off()
...
g5 <- ggplot(data = rgakPDO, aes(y=Type, x=Lag, fill=coef)) + 
  geom_tile(color = "white") +
  scale_fill_distiller(palette = "RdBu", limit = c(-0.51,0.51),  
                       name="PDO\nCoef") +
  theme_minimal() + labs(x="")+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, 
                                   size = 8, hjust = 1)) +
...
png(paste0(figp,'Heatmaps_GAK_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
h5 <- ggplot(data = rhiPDO, aes(y=Type, x=Lag, fill=coef)) + 
  geom_tile(color = "white") +
  scale_fill_distiller(palette = "RdBu", limit = c(-0.25,0.25),  
                       name="PDO\nCoef") +
  theme_minimal() + labs(x="")+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, 
                                   size = 8, hjust = 1)) +
...
png(paste0(figp,'Heatmaps_HI_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
png(paste0(figp,'Heatmaps_CHK_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
png(paste0(figp,'Heatmaps_GMX_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
png(paste0(figp,'Heatmaps_SE_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
png(paste0(figp,'Heatmaps_NE_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
### EBS benthic & CCE pelagic together
png(paste0(figp,'Heatmaps_EBS_CCE_coef_select_climate_inputs_fish.png'), 
    width = 10*300,        # 5 x 300 pixels
    height = 6*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
plot_grid( e4,e5,e3,c4,c5,
           nrow = 2, ncol = 3)
#rel_widths = c(1,1), rel_heights = c(1,1,1) ,
#align = 'h' )#, labels = "auto", label_size = 12, hjust = -4)
dev.off()
