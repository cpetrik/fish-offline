...
fcoef <- read.csv(paste0(datar,"LME_sig_corr_maxlag_driver_yield_obsfish_F.csv"),sep=",",header = T,stringsAsFactors = F)
pcoef <- read.csv(paste0(datar,"LME_sig_corr_maxlag_driver_yield_obsfish_P.csv"),sep=",",header = T,stringsAsFactors = F)
dcoef <- read.csv(paste0(datar,"LME_sig_corr_maxlag_driver_yield_obsfish_D.csv"),sep=",",header = T,stringsAsFactors = F)
acoef <- read.csv(paste0(datar,"LME_sig_corr_maxlag_driver_yield_obsfish_A.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,"heatmap_LME_driver_yield_obsfish_A_sig_corr_coeffs_4clus.png"),    # create PNG for the heat map        
...
png(paste0(figp,"heatmap_LME_driver_yield_obsfish_F_sig_corr_coeffs_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"heatmap_LME_driver_yield_obsfish_P_sig_corr_coeffs_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"heatmap_LME_driver_yield_obsfish_D_sig_corr_coeffs_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
### Save clustering
write.table(acoef,paste0(datar,"LME_driver_yield_obsfish_A_sig_corr_coeffs_cluster.csv"),sep=",",row.names=F)
write.table(fcoef,paste0(datar,"LME_driver_yield_obsfish_F_sig_corr_coeffs_cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_driver_yield_obsfish_P_sig_corr_coeffs_cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_driver_yield_obsfish_D_sig_corr_coeffs_cluster.csv"),sep=",",row.names=F)
