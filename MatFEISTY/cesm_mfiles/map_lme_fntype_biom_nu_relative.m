...
lme_ptot = sum(lme_nu,2);

lbio = lme_type ./ repmat(lme_btot,1,3);
lnu = lme_nu ./ repmat(lme_ptot,1,3);

%% Biomass & nu bar plots
figure(1)
subplot(3,2,1)
...
subplot(3,2,2)
bar(lme_nu(lid,:))
ylabel('Productivity (gWW/gWW/m2/y)')
set(gca,'XTickLabel',lname)
...
set(gca,'XTickLabel',lname)
ylim([0 1])
print('-dpng',[ppath 'Bar_USLMEs_biom_nu_fntypes.png'])
...
print('-dpng',[ppath 'Map_LMEs_rel_biom_nu_fntypes.png'])
