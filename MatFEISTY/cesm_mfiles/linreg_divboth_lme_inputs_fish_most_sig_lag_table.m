...
for L = 1:length(lid)
    ...
    %%
    %save([spath,ilme,'_regress_drivers_ALLdiv2SD_0_5_lag.mat'])
...
%%
writetable(Ftab1,[spath,'LMEs_regress_driver_ALLdiv2SD_maxcoef_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_regress_driver_ALLdiv2SD_maxcoef_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_regress_driver_ALLdiv2SD_maxcoef_D.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'LMEs_regress_driver_ALLdiv2SD_maxcoef_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Btab1,[spath,'LMEs_regress_driver_ALLdiv2SD_maxcoef_B.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'LMEs_regress_driver_ALLdiv2SD_maxcoefs.mat'],...
