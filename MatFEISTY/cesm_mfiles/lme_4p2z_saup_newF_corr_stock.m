%CESM-4P2Z-FEISTY catch vs. SAUP catch by LME
%Use same methods as Stock et al. 2017 to reduce SAUP dataset
%Added squids to F catch
...
writetable(Fstat,[dpath 'LME_SAUP_newF_stats_' mod cfile '.csv'],'Delimiter',',',...
    'WriteRowNames',true)
save([dpath 'LME_SAUP_newF_stats_' mod cfile '.mat'],'fish_stat')
...
ylabel('FEISTY ')
title('All fishes')
print('-dpng',[ppath mod,'SAUP_newF_comp_types_temp_Stock_LELC.png'])
...
print('-dpng',[ppath mod,'SAUP_newF_comp_types_temp_Stock_LELC_noF.png'])
...
% ylabel('FEISTY ')
% title('Large Pelagics')
% print('-dpng',[ppath mod,'SAUP_newF_comp_P_Stock_LELC_temp.png'])
...
ylabel('FEISTY ')
title('Large Pelagics vs Demersals')
print('-dpng',[ppath mod,'SAUP_newF_comp_PDratio_Stock_LELC_temp.png'])
