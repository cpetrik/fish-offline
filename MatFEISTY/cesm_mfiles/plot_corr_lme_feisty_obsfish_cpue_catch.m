...
print('-dpng',[ppath 'Bar_LMEs_cpue_catch_feisty_obsfish_maxcorr_v3_allfish.png'])
...
subplot('Position',[0.1 0.525 0.35 0.45]) %Top L
...
subplot('Position',[0.5 0.525 0.43 0.45]) %Top R
axesm ('Robinson','MapLatLimit',clatlim,'MapLonLimit',clonlim,'frame','on',...
    'Grid','off','FLineWidth',1)
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
hold on
...
subplot('Position',[0.1 0.05 0.35 0.45]) %Bottom L
axesm ('Robinson','MapLatLimit',clatlim,'MapLonLimit',clonlim,'frame','on',...
    'Grid','off','FLineWidth',1)
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
hold on
...
subplot('Position',[0.5 0.05 0.35 0.45]) %Bottom R
axesm ('Robinson','MapLatLimit',clatlim,'MapLonLimit',clonlim,'frame','on',...
    'Grid','off','FLineWidth',1)
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
hold on
...
print('-dpng',[ppath 'Map_LMEs_cpue_catch_feisty_obsfish_pos_maxcorr_v3_allfish.png'])
