...
save([fpath,'FOSI_nu_regress_drivers_ALLdiv2SD.mat'],'tanom','tfish',...
    'tyr','yr');
...
for L = 1:length(lid)
    ...
    eval(['save(''' [fpath 'FOSI_nu_regress_drivers_ALLdiv2SD.mat'] ''',''' ['Cmat_nosize_' ilme] ''',''-append'')']);
    eval(['save(''' [fpath 'FOSI_nu_regress_drivers_ALLdiv2SD.mat'] ''',''' ['Pmat_nosize_' ilme] ''',''-append'')']);
