...
png(paste0(figp,"hclust_wardD_heatmap_LME_A_mlr_coeffs_R2_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
...
png(paste0(figp,"hclust_wardD_heatmap_LME_F_mlr_coeffs_R2_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
# Color the branches based on the clusters:
pdfish <- color_branches(pdfish,k=7) #
# reduce the size of the labels:
pdfish <- set(pdfish, "labels_cex", 0.8)

png(paste0(figp,"hclust_wardD_heatmap_LME_P_mlr_coeffs_R2_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_D_mlr_coeffs_R2_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_B_mlr_coeffs_R2_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
## Forage
fdend_k <- cutree(fdfish, k=7)
fcoef50$Cluster <- fdend_k

## Lg Pel
pdend_k <- cutree(pdfish, k=7)
...
write.table(fcoef,paste0(datar,"LME_F_mlr_coeffs_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_P_mlr_coeffs_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_D_mlr_coeffs_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_A_mlr_coeffs_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
write.table(bcoef,paste0(datar,"LME_B_mlr_coeffs_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
...
png(paste0(figp,"hclust_wardD_heatmap_LME_A_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
fdend_7 <- cutree(fdfish, k=6)
fcoef$Cluster <- fdend_7
# reduce the size of the labels:
fdfish <- set(fdfish, "labels_cex", 0.8)

png(paste0(figp,"hclust_wardD_heatmap_LME_F_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_P_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_D_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_B_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
