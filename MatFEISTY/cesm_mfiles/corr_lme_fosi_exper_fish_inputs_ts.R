...
sigS <- read.csv(paste0(ddir,"LME_fosi_fished_v15_All_fish03_sigS_inputs.csv"),sep=",",header = F,stringsAsFactors = T)
sigM <- read.csv(paste0(ddir,"LME_fosi_fished_v15_All_fish03_sigM_inputs.csv"),sep=",",header = F,stringsAsFactors = T)
sigL <- read.csv(paste0(ddir,"LME_fosi_fished_v15_All_fish03_sigL_inputs.csv"),sep=",",header = F,stringsAsFactors = T)
sigF <- read.csv(paste0(ddir,"LME_fosi_fished_v15_All_fish03_sigF_inputs.csv"),sep=",",header = F,stringsAsFactors = T)
sigP <- read.csv(paste0(ddir,"LME_fosi_fished_v15_All_fish03_sigP_inputs.csv"),sep=",",header = F,stringsAsFactors = T)
sigD <- read.csv(paste0(ddir,"LME_fosi_fished_v15_All_fish03_sigD_inputs.csv"),sep=",",header = F,stringsAsFactors = T)
sigA <- read.csv(paste0(ddir,"LME_fosi_fished_v15_All_fish03_sigA_inputs.csv"),sep=",",header = F,stringsAsFactors = T)
sigB <- read.csv(paste0(ddir,"LME_fosi_fished_v15_All_fish03_sigB_inputs.csv"),sep=",",header = F,stringsAsFactors = T)
...
write.table(sigCHK,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_input_corrs_CHK.csv"),sep=",",row.names=F)
write.table(sigEBS,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_input_corrs_EBS.csv"),sep=",",row.names=F)
write.table(sigGAK,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_input_corrs_GAK.csv"),sep=",",row.names=F)
write.table(sigCCE,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_input_corrs_CCE.csv"),sep=",",row.names=F)
write.table(sigHI,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_input_corrs_HI.csv"),sep=",",row.names=F)
write.table(sigGMX,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_input_corrs_GMX.csv"),sep=",",row.names=F)
write.table(sigSE,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_input_corrs_SE.csv"),sep=",",row.names=F)
write.table(sigNE,paste0(ddir,"LME_fosi_fished_v15_All_fish03_sig_input_corrs_NE.csv"),sep=",",row.names=F)
