...
png(paste0(figp,"reduc_heatmap_LME_A_cpue_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
...
png(paste0(figp,"reduc_heatmap_LME_F_cpue_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_P_cpue_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_D_cpue_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
write.table(fcoef,paste0(datar,"LME_FishMIP_cpue_F_mlr_coeffs_reduc_ALLdiv2SD_alllags_R2_025_cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_FishMIP_cpue_P_mlr_coeffs_reduc_ALLdiv2SD_alllags_R2_025_cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_FishMIP_cpue_D_mlr_coeffs_reduc_ALLdiv2SD_alllags_R2_025_cluster.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_FishMIP_cpue_A_mlr_coeffs_reduc_ALLdiv2SD_alllags_R2_025_cluster.csv"),sep=",",row.names=F)
