...
for i=1:length(pid)
    ...
    %climate = PDO
    yyaxis left
    plot(yr,manom(10,:),'color',0.5*[1 1 1]); hold on;
    ylim([-2.1 2.1])
    ylabel('PDO')
    yyaxis right
    %Sm
...
print('-dpng',[ppath 'ts_climateDJF_FOSI_NPac_PDO_',mod,'size_v2.png'])
...
for i=1:length(pid)
    ...
    %climate = ENSO
    yyaxis left
    plot(yr,manom(6,:),'color',0.5*[1 1 1]); hold on;
    ylim([-1.5 1.5])
    ylabel('ENSO')
    yyaxis right
    %Sm
...
lg.Location = 'southoutside';
lg.Orientation = 'horizontal';
print('-dpng',[ppath 'ts_climateDJF_FOSI_NPac_ENSO_',mod,'size_v2.png'])
...
lg.Location = 'southoutside';
lg.Orientation = 'horizontal';
print('-dpng',[ppath 'ts_climateDJF_FOSI_NAtl_AMO_',mod,'size_v2.png'])
...
lg.Location = 'southoutside';
lg.Orientation = 'horizontal';
print('-dpng',[ppath 'ts_climateDJF_FOSI_NAtl_NAO_',mod,'size_v2.png'])
...
print('-dpng',[ppath 'ts_climateDJF_FOSI_EBS_CCE_',mod,'size_only_v2.png'])
...
lg.Location = 'southoutside';
lg.Orientation = 'horizontal';
print('-dpng',[ppath 'ts_climateDJF_FOSI_PDO_AMO_',mod,'size_v2.png'])
