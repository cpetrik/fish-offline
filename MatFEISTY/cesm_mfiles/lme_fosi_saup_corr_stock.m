...
dpath=['/Volumes/petrik-lab/Feisty/NC/CESM_MAPP/' cfile '/'];
ppath = [pp cfile '/'];
if (~isfolder(ppath))
    mkdir(ppath)
end
...
ylabel('FEISTY ')
title('All fishes')
print('-dpng',[ppath mod,'SAUP_comp_types_temp_Stock_LELC.png'])
...
print('-dpng',[ppath mod,'SAUP_comp_types_temp_Stock_LELC_noF.png'])
...
% ylabel('FEISTY ')
% title('Large Pelagics')
% print('-dpng',[ppath mod,'SAUP_comp_P_Stock_LELC_temp.png'])
...
ylabel('FEISTY ')
title('Large Pelagics vs Demersals')
print('-dpng',[ppath mod,'SAUP_comp_PDratio_Stock_LELC_temp.png'])
