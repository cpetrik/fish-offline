...
fcoef <- read.csv(paste0(datar,"LME_F_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
pcoef <- read.csv(paste0(datar,"LME_P_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
dcoef <- read.csv(paste0(datar,"LME_D_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
acoef <- read.csv(paste0(datar,"LME_A_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
bcoef <- read.csv(paste0(datar,"LME_B_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)

fpval <- read.csv(paste0(datar,"LME_F_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
ppval <- read.csv(paste0(datar,"LME_P_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
dpval <- read.csv(paste0(datar,"LME_D_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
apval <- read.csv(paste0(datar,"LME_A_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
bpval <- read.csv(paste0(datar,"LME_B_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",header = T,stringsAsFactors = F)
