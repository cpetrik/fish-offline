...
### Rearrange =====================================================
## CCE
ccePDO <- read.csv(paste0(datap,"CCE_regressDJF_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
cceNino34 <- read.csv(paste0(datap,"CCE_regressDJF_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
## EBS
ebsPDO <- read.csv(paste0(datap,"EBS_regressDJF_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
ebsNino34 <- read.csv(paste0(datap,"EBS_regressDJF_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
ebsAO <- read.csv(paste0(datap,"EBS_regressDJF_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
## AI
aiPDO <- read.csv(paste0(datap,"AI_regressDJF_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
aiNino34 <- read.csv(paste0(datap,"AI_regressDJF_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
aiAO <- read.csv(paste0(datap,"AI_regressDJF_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
## GAK
gakPDO <- read.csv(paste0(datap,"GAK_regressDJF_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
gakNino34 <- read.csv(paste0(datap,"GAK_regressDJF_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
gakAO <- read.csv(paste0(datap,"GAK_regressDJF_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
## HI
hiPDO <- read.csv(paste0(datap,"HI_regressDJF_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
hiNino34 <- read.csv(paste0(datap,"HI_regressDJF_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
## CHK
chkPDO <- read.csv(paste0(datap,"CHK_regressDJF_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
chkAMO <- read.csv(paste0(datap,"CHK_regressDJF_AMO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
chkAO <- read.csv(paste0(datap,"CHK_regressDJF_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
##GMX
gmxPDO <- read.csv(paste0(datap,"GMX_regressDJF_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
gmxNAO <- read.csv(paste0(datap,"GMX_regressDJF_NAO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
gmxAO <- read.csv(paste0(datap,"GMX_regressDJF_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
## NE
neNAO <- read.csv(paste0(datap,"NE_regressDJF_NAO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
neAMO <- read.csv(paste0(datap,"NE_regressDJF_AMO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
##SE
seNAO <- read.csv(paste0(datap,"SE_regressDJF_NAO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
seAMO <- read.csv(paste0(datap,"SE_regressDJF_AMO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,'Heatmaps_CCE_EBS_GAK_NE_coef_select_climateDJF_inputs_fntypes.png'), 
...
png(paste0(figp,'Heatmaps_AI_GAK_HI_GMX_SE_coef_select_climateDJF_inputs_fntypes.png'), 
    width = 7.5*300,        # 5 x 300 pixels
    height = 10*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
