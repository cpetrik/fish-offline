...
png(paste0(figp,'Heatmaps_CCE_EBS_GAK_NE_coef_select_climateDJF_inputs_fish.png'), 
...
png(paste0(figp,'Heatmaps_AI_GAK_HI_GMX_SE_coef_select_climateDJF_inputs_fish.png'), 
    width = 7.5*300,        # 5 x 300 pixels
    height = 10*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
