% Grid cell linear regressions of FEISTY FOSI input & output
% w/climate indices
% apply fn
...
for k=1%:length(yr) %Linear regression at diff lags
    for j=csub %1:11 %Diff climate indices
        %%
        t = yr(k);
...
toc
%%
save([fpath 'grid_linreg2_climate_inputs_fish_FOSI_fished_',mod,'.mat'],...
