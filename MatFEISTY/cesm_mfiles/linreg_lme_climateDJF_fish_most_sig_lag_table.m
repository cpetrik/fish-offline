...
load([apath 'Climate_anomalies_DJF_means.mat']);
...
for L = 1:length(lid)
    ...
    %%
    %save([spath,ilme,'_regressDJF_climate5_div2SD_0_5_lag.mat'])
...
%%
writetable(Ftab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_D.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Btab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_B.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TPtab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_TP.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TBtab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_TB.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(POCtab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_POC.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(ZMtab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_ZM.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(ZLtab1,[spath,'LMEs_regressDJF_climate_div2SD_maxcoef_ZL.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'LMEs_regressDJF_climate_div2SD_maxcoefs.mat'],...
