...
for L = 1:length(lid)
    ...
    ilme = lname{L};
    %%
    load([spath,ilme,'_regress_climate5_div2SD_0_5_lag.mat'])
    ...
    %%
    %save([spath,ilme,'_regress_climate5_div2SD_0_5_lag.mat'])
    writetable(FtC,[spath,ilme,'_regress_climate_div2SD_coefs_F.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(PtC,[spath,ilme,'_regress_climate_div2SD_coefs_P.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(DtC,[spath,ilme,'_regress_climate_div2SD_coefs_D.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(AtC,[spath,ilme,'_regress_climate_div2SD_coefs_A.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(BtC,[spath,ilme,'_regress_climate_div2SD_coefs_B.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(TPtC,[spath,ilme,'_regress_climate_div2SD_coefs_TP.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(TBtC,[spath,ilme,'_regress_climate_div2SD_coefs_TB.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(DEtC,[spath,ilme,'_regress_climate_div2SD_coefs_POC.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(ZMtC,[spath,ilme,'_regress_climate_div2SD_coefs_ZM.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(ZLtC,[spath,ilme,'_regress_climate_div2SD_coefs_ZL.csv'],...
        'Delimiter',',','WriteRowNames',true);

    writetable(FtP,[spath,ilme,'_regress_climate_div2SD_pvals_F.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(PtP,[spath,ilme,'_regress_climate_div2SD_pvals_P.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(DtP,[spath,ilme,'_regress_climate_div2SD_pvals_D.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(AtP,[spath,ilme,'_regress_climate_div2SD_pvals_A.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(BtP,[spath,ilme,'_regress_climate_div2SD_pvals_B.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(TPtP,[spath,ilme,'_regress_climate_div2SD_pvals_TP.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(TBtP,[spath,ilme,'_regress_climate_div2SD_pvals_TB.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(DEtP,[spath,ilme,'_regress_climate_div2SD_pvals_POC.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(ZMtP,[spath,ilme,'_regress_climate_div2SD_pvals_ZM.csv'],...
        'Delimiter',',','WriteRowNames',true);
    writetable(ZLtP,[spath,ilme,'_regress_climate_div2SD_pvals_ZL.csv'],...
        'Delimiter',',','WriteRowNames',true);
