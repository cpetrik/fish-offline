...
%climate = PDO
yyaxis left
plot(CKanom(:,1),manom(10,:),'color',0.5*[1 1 1]); hold on;
ylim([-2 2])
ylabel('PDO')
yyaxis right
%Sm
...
print('-dpng',[ppath 'ts_climateDJF_FOSI_NPac_PDO_',mod,'size.png'])
...
%climate = ENSO
yyaxis left
plot(CKanom(:,1),manom(6,:),'color',0.5*[1 1 1]); hold on;
ylim([-1.5 1.5])
ylabel('ENSO')
yyaxis right
%Sm
...
%climate = ENSO
yyaxis left
plot(BSanom(:,1),manom(6,:),'color',0.5*[1 1 1]); hold on;
ylim([-1.5 1.5])
ylabel('ENSO')
yyaxis right
%S
...
%climate = ENSO
yyaxis left
plot(AKanom(:,1),manom(6,:),'color',0.5*[1 1 1]); hold on;
ylim([-1.5 1.5])
ylabel('ENSO')
yyaxis right
%S
...
%climate = ENSO
yyaxis left
plot(CCanom(:,1),manom(6,:),'color',0.5*[1 1 1]); hold on;
ylim([-1.5 1.5])
ylabel('ENSO')
yyaxis right
%S
...
lg.Location = 'southoutside';
lg.Orientation = 'horizontal';
print('-dpng',[ppath 'ts_climateDJF_FOSI_NPac_ENSO_',mod,'size.png'])  
...
lg.Location = 'southoutside';
lg.Orientation = 'horizontal';
print('-dpng',[ppath 'ts_climateDJF_FOSI_NAtl_AMO_',mod,'size.png'])
...
nexttile
yyaxis left
plot(NEanom(:,1),manom(4,:),'color',0.5*[1 1 1]); hold on;
ylim([-3 3])
ylabel('NAO')
yyaxis right
%Sm
...
% SE
yyaxis left
plot(SEanom(:,1),manom(4,:),'color',0.5*[1 1 1]); hold on;
ylim([-3 3])
ylabel('NAO')
yyaxis right
%S
...
%climate = NAO
yyaxis left
plot(MXanom(:,1),manom(4,:),'color',0.5*[1 1 1]); hold on;
ylim([-3 3])
ylabel('NAO')
yyaxis right
%S
...
lg.Location = 'southoutside';
lg.Orientation = 'horizontal';
print('-dpng',[ppath 'ts_climateDJF_FOSI_NAtl_NAO_',mod,'size.png'])
...
print('-dpng',[ppath 'ts_climateDJF_FOSI_EBS_CCE_',mod,'size_only.png'])
...
lg.Location = 'southoutside';
lg.Orientation = 'horizontal';
print('-dpng',[ppath 'ts_climateDJF_FOSI_PDO_AMO_',mod,'size.png'])
