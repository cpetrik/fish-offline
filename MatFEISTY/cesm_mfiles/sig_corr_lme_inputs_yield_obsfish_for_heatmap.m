...
writetable(Ftab,[rpath,'LME_sig_corr_maxlag_driver_yield_obsfish_F.csv'],...
    'Delimiter',',');
writetable(Ptab,[rpath,'LME_sig_corr_maxlag_driver_yield_obsfish_P.csv'],...
    'Delimiter',',');
writetable(Dtab,[rpath,'LME_sig_corr_maxlag_driver_yield_obsfish_D.csv'],...
    'Delimiter',',');
writetable(Atab,[rpath,'LME_sig_corr_maxlag_driver_yield_obsfish_A.csv'],...
    'Delimiter',',');

save([rpath,'LME_sig_corr_maxlag_driver_yield_obsfish.mat'],'lid',...
