...
figure(4)
subplot(2,1,1)
plot(y,log10(SF.bio(fid3(100:110),:))); hold on;
xlim([y(1) y(end)])
ylim([-8 0])
xlabel('Time (y)')
ylabel('log_1_0 Biomass (g m^-^2)')
...
subplot(2,1,2)
plot(y,log10(SP.bio(pid3(100:110),:))); hold on;
xlim([y(1) y(end)])
ylim([-8 0])
xlabel('Time (y)')
ylabel('log_1_0 Biomass (g m^-^2)')
...
figure(4)
subplot(2,1,1)
plot(y,log10(MF.bio(fid3(100:110),:))); hold on;
xlim([y(1) y(end)])
ylim([-8 0])
xlabel('Time (y)')
ylabel('log_1_0 Biomass (g m^-^2)')
...
subplot(2,1,2)
plot(y,log10(MP.bio(pid3(100:110),:))); hold on;
xlim([y(1) y(end)])
ylim([-8 0])
xlabel('Time (y)')
ylabel('log_1_0 Biomass (g m^-^2)')
