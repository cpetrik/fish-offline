...
%% Save climatologies
save([fpath 'cesm_fosi_v6_climatol_68yrs.mat'],'TLAT','TLONG',...
...
axesm ('Robinson','MapLatLimit',clatlim,'MapLonLimit',clonlim,'frame','on',...
    'Grid','off','FLineWidth',1)
surfm(LAT,LON,log10(squeeze(mhp_clim(:,:,t))))
cmocean('tempo')
caxis([-2 1])
...
%%
print(f1,'-dpng',[pp 'Map_FOSI_v6_Tp_clim.png'])
print(f2,'-dpng',[pp 'Map_FOSI_v6_Tb_clim.png'])
print(f3,'-dpng',[pp 'Map_FOSI_v6_MZ_clim.png'])
print(f6,'-dpng',[pp 'Map_FOSI_v6_MZloss_clim.png'])
print(f9,'-dpng',[pp 'Map_FOSI_v6_Det_clim.png'])
...
subplot(2,3,2)
plot(1:12,mz_mclim,'k')
xlim([1 12])
title('MZ')

subplot(2,3,3)
plot(1:12,mhp_mclim,'k')
xlim([1 12])
title('MZloss')
...
subplot(2,3,5)
plot(1:12,det_mclim,'k')
xlim([1 12])
title('Det')
print('-dpng',[pp 'ts_FOSI_v6_all_clim_gm2d.png'])
