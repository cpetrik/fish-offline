...
for (j in 1:11) {
  ...
  AKtab <- data.frame(matrix(ncol = 6, nrow = 78))
  colnames(AKtab) <- cnam
  BStab <- data.frame(matrix(ncol = 6, nrow = 78))
  colnames(BStab) <- cnam
  CCtab <- data.frame(matrix(ncol = 6, nrow = 78))
  colnames(CCtab) <- cnam
  CHtab <- data.frame(matrix(ncol = 6, nrow = 78))
  colnames(CHtab) <- cnam
  HItab <- data.frame(matrix(ncol = 6, nrow = 78))
  colnames(HItab) <- cnam
  MXtab <- data.frame(matrix(ncol = 6, nrow = 78))
  colnames(MXtab) <- cnam
  NEtab <- data.frame(matrix(ncol = 6, nrow = 78))
  colnames(NEtab) <- cnam
  SEtab <- data.frame(matrix(ncol = 6, nrow = 78))
  colnames(SEtab) <- cnam
