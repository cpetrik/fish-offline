...
### Rearrange =====================================================
## CCE
ccePDO <- read.csv(paste0(datap,"CCE_regress_seasonal_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
ccePDO$Lag <- as.factor(ccePDO$Lag)
ccePDO$Type[ccePDO$Type=="Zlos"] <- "ZmLoss"
ccePDO$Type[ccePDO$Type=="Zoo"] <- "Zmeso"
ccePDO <- subset.data.frame(ccePDO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
ccePDO$Type <- factor(ccePDO$Type, 
                         levels = c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
cceNino34 <- read.csv(paste0(datap,"CCE_regress_seasonal_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
cceNino34$Lag <- as.factor(cceNino34$Lag)
cceNino34$Type[cceNino34$Type=="Zlos"] <- "ZmLoss"
cceNino34$Type[cceNino34$Type=="Zoo"] <- "Zmeso"
cceNino34 <- subset.data.frame(cceNino34,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
## EBS
ebsPDO <- read.csv(paste0(datap,"EBS_regress_seasonal_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
ebsPDO$Lag <- as.factor(ebsPDO$Lag)
ebsPDO$Type[ebsPDO$Type=="Zlos"] <- "ZmLoss"
ebsPDO$Type[ebsPDO$Type=="Zoo"] <- "Zmeso"
ebsPDO <- subset.data.frame(ebsPDO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
ebsNino34 <- read.csv(paste0(datap,"EBS_regress_seasonal_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
ebsNino34$Lag <- as.factor(ebsNino34$Lag)
ebsNino34$Type[ebsNino34$Type=="Zlos"] <- "ZmLoss"
ebsNino34$Type[ebsNino34$Type=="Zoo"] <- "Zmeso"
ebsNino34 <- subset.data.frame(ebsNino34,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
ebsAO <- read.csv(paste0(datap,"EBS_regress_seasonal_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
ebsAO$Lag <- as.factor(ebsAO$Lag)
ebsAO$Type[ebsAO$Type=="Zlos"] <- "ZmLoss"
ebsAO$Type[ebsAO$Type=="Zoo"] <- "Zmeso"
ebsAO <- subset.data.frame(ebsAO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
## AI
aiPDO <- read.csv(paste0(datap,"AI_regress_seasonal_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
aiPDO$Lag <- as.factor(aiPDO$Lag)
aiPDO$Type[aiPDO$Type=="Zlos"] <- "ZmLoss"
aiPDO$Type[aiPDO$Type=="Zoo"] <- "Zmeso"
aiPDO <- subset.data.frame(aiPDO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
aiNino34 <- read.csv(paste0(datap,"AI_regress_seasonal_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
aiNino34$Lag <- as.factor(aiNino34$Lag)
aiNino34$Type[aiNino34$Type=="Zlos"] <- "ZmLoss"
aiNino34$Type[aiNino34$Type=="Zoo"] <- "Zmeso"
aiNino34 <- subset.data.frame(aiNino34,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
aiAO <- read.csv(paste0(datap,"AI_regress_seasonal_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
aiAO$Lag <- as.factor(aiAO$Lag)
aiAO$Type[aiAO$Type=="Zlos"] <- "ZmLoss"
aiAO$Type[aiAO$Type=="Zoo"] <- "Zmeso"
aiAO <- subset.data.frame(aiAO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
## GAK
gakPDO <- read.csv(paste0(datap,"GAK_regress_seasonal_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
gakPDO$Lag <- as.factor(gakPDO$Lag)
gakPDO$Type[gakPDO$Type=="Zlos"] <- "ZmLoss"
gakPDO$Type[gakPDO$Type=="Zoo"] <- "Zmeso"
gakPDO <- subset.data.frame(gakPDO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
gakNino34 <- read.csv(paste0(datap,"GAK_regress_seasonal_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
gakNino34$Lag <- as.factor(gakNino34$Lag)
gakNino34$Type[gakNino34$Type=="Zlos"] <- "ZmLoss"
gakNino34$Type[gakNino34$Type=="Zoo"] <- "Zmeso"
gakNino34 <- subset.data.frame(gakNino34,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
gakAO <- read.csv(paste0(datap,"GAK_regress_seasonal_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
gakAO$Lag <- as.factor(gakAO$Lag)
gakAO$Type[gakAO$Type=="Zlos"] <- "ZmLoss"
gakAO$Type[gakAO$Type=="Zoo"] <- "Zmeso"
gakAO <- subset.data.frame(gakAO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
## HI
hiPDO <- read.csv(paste0(datap,"HI_regress_seasonal_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
hiPDO$Lag <- as.factor(hiPDO$Lag)
hiPDO$Type[hiPDO$Type=="Zlos"] <- "ZmLoss"
hiPDO$Type[hiPDO$Type=="Zoo"] <- "Zmeso"
hiPDO <- subset.data.frame(hiPDO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
hiNino34 <- read.csv(paste0(datap,"HI_regress_seasonal_Nino34_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
hiNino34$Lag <- as.factor(hiNino34$Lag)
hiNino34$Type[hiNino34$Type=="Zlos"] <- "ZmLoss"
hiNino34$Type[hiNino34$Type=="Zoo"] <- "Zmeso"
hiNino34 <- subset.data.frame(hiNino34,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
## CHK
chkPDO <- read.csv(paste0(datap,"CHK_regress_seasonal_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
chkPDO$Lag <- as.factor(chkPDO$Lag)
chkPDO$Type[chkPDO$Type=="Zlos"] <- "ZmLoss"
chkPDO$Type[chkPDO$Type=="Zoo"] <- "Zmeso"
chkPDO <- subset.data.frame(chkPDO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
chkAMO <- read.csv(paste0(datap,"CHK_regress_seasonal_AMO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
chkAMO$Lag <- as.factor(chkAMO$Lag)
chkAMO$Type[chkAMO$Type=="Zlos"] <- "ZmLoss"
chkAMO$Type[chkAMO$Type=="Zoo"] <- "Zmeso"
chkAMO <- subset.data.frame(chkAMO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
chkAO <- read.csv(paste0(datap,"CHK_regress_seasonal_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
chkAO$Lag <- as.factor(chkAO$Lag)
chkAO$Type[chkAO$Type=="Zlos"] <- "ZmLoss"
chkAO$Type[chkAO$Type=="Zoo"] <- "Zmeso"
chkAO <- subset.data.frame(chkAO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
##GMX
gmxPDO <- read.csv(paste0(datap,"GMX_regress_seasonal_PDO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
gmxPDO$Lag <- as.factor(gmxPDO$Lag)
gmxPDO$Type[gmxPDO$Type=="Zlos"] <- "ZmLoss"
gmxPDO$Type[gmxPDO$Type=="Zoo"] <- "Zmeso"
gmxPDO <- subset.data.frame(gmxPDO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
gmxNAO <- read.csv(paste0(datap,"GMX_regress_seasonal_NAO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
gmxNAO$Lag <- as.factor(gmxNAO$Lag)
gmxNAO$Type[gmxNAO$Type=="Zlos"] <- "ZmLoss"
gmxNAO$Type[gmxNAO$Type=="Zoo"] <- "Zmeso"
gmxNAO <- subset.data.frame(gmxNAO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
gmxAO <- read.csv(paste0(datap,"GMX_regress_seasonal_AO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
gmxAO$Lag <- as.factor(gmxAO$Lag)
gmxAO$Type[gmxAO$Type=="Zlos"] <- "ZmLoss"
gmxAO$Type[gmxAO$Type=="Zoo"] <- "Zmeso"
gmxAO <- subset.data.frame(gmxAO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
## NE
neNAO <- read.csv(paste0(datap,"NE_regress_seasonal_NAO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
neNAO$Lag <- as.factor(neNAO$Lag)
neNAO$Type[neNAO$Type=="Zlos"] <- "ZmLoss"
neNAO$Type[neNAO$Type=="Zoo"] <- "Zmeso"
neNAO <- subset.data.frame(neNAO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
neAMO <- read.csv(paste0(datap,"NE_regress_seasonal_AMO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
neAMO$Lag <- as.factor(neAMO$Lag)
neAMO$Type[neAMO$Type=="Zlos"] <- "ZmLoss"
neAMO$Type[neAMO$Type=="Zoo"] <- "Zmeso"
neAMO <- subset.data.frame(neAMO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
##SE
seNAO <- read.csv(paste0(datap,"SE_regress_seasonal_NAO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
seNAO$Lag <- as.factor(seNAO$Lag)
seNAO$Type[seNAO$Type=="Zlos"] <- "ZmLoss"
seNAO$Type[seNAO$Type=="Zoo"] <- "Zmeso"
seNAO <- subset.data.frame(seNAO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
seAMO <- read.csv(paste0(datap,"SE_regress_seasonal_AMO_div2SD_melt_mat.csv"),sep=",",header = T,stringsAsFactors = F)
seAMO$Lag <- as.factor(seAMO$Lag)
seAMO$Type[seAMO$Type=="Zlos"] <- "ZmLoss"
seAMO$Type[seAMO$Type=="Zoo"] <- "Zmeso"
seAMO <- subset.data.frame(seAMO,Type %in% c("Tb","Det","B","D","A","P","F","ZmLoss","Zmeso","Tp"))
...
png(paste0(figp,'Heatmaps_CCE_EBS_GAK_NE_coef_select_climate_seasonal_inputs_fntypes.png'), 
...
png(paste0(figp,'Heatmaps_AI_GAK_HI_GMX_SE_coef_select_climate_seasonal_inputs_fntypes.png'), 
    width = 7.5*300,        # 5 x 300 pixels
    height = 10*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
