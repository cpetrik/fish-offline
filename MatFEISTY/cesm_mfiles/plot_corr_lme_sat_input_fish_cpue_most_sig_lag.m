% Plot max corr of driver-cpue corrs
% For all 63 LMEs
...
print('-dpng',[ppath 'Bar_LMEs_cpue_sat_driver_feisty_maxcorr_allfish.png'])
...
stamp('CPUE corr')
print('-dpng',[ppath 'Map_LMEs_cpue_sat_driver_feisty_maxcorr_allfish.png'])
...
stamp('CPUE corr')
print('-dpng',[ppath 'Map_LMEs_cpue_sat_driver_feisty_maxcorr_coeff_allfish.png'])
...
stamp('CPUE R^2')
print('-dpng',[ppath 'Map_LMEs_cpue_sat_driver_feisty_maxcorr_r2_allfish.png'])
