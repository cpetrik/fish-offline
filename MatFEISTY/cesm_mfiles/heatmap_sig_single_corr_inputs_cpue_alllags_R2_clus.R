...
png(paste0(figp,"heatmap_LME_driver_cpue_A_sig_corr_coeffs_4clus.png"),    # create PNG for the heat map        
...
png(paste0(figp,"heatmap_LME_driver_cpue_D_sig_corr_coeffs_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
### Save clustering
write.table(acoef,paste0(datar,"LME_driver_cpue_A_sig_corr_coeffs_4cluster.csv"),sep=",",row.names=F)
write.table(fcoef,paste0(datar,"LME_driver_cpue_F_sig_corr_coeffs_4cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_driver_cpue_P_sig_corr_coeffs_5cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_driver_cpue_D_sig_corr_coeffs_5cluster.csv"),sep=",",row.names=F)
