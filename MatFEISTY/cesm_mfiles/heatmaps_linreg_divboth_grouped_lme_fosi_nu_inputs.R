...
# All anomaly time series divided by 2SD
# Change all to same color scale?
...
library(ggplot2)
library(reshape2) #ALLdiv2SD_melt
...
### Rearrange =====================================================
## CCE
cceDet <- read.csv(paste0(datap,"CCE_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
cceTB <- read.csv(paste0(datap,"CCE_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
cceTP <- read.csv(paste0(datap,"CCE_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
cceZmeso <- read.csv(paste0(datap,"CCE_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
cceZmLoss <- read.csv(paste0(datap,"CCE_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
## EBS
ebsDet <- read.csv(paste0(datap,"EBS_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
ebsTB <- read.csv(paste0(datap,"EBS_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
ebsTP <- read.csv(paste0(datap,"EBS_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
ebsZmeso <- read.csv(paste0(datap,"EBS_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
ebsZmLoss <- read.csv(paste0(datap,"EBS_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
## AI
aiDet <- read.csv(paste0(datap,"AI_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
aiTB <- read.csv(paste0(datap,"AI_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
aiTP <- read.csv(paste0(datap,"AI_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
aiZmeso <- read.csv(paste0(datap,"AI_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
aiZmLoss <- read.csv(paste0(datap,"AI_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
## GAK
gakDet <- read.csv(paste0(datap,"GAK_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
gakTB <- read.csv(paste0(datap,"GAK_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
gakTP <- read.csv(paste0(datap,"GAK_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
gakZmeso <- read.csv(paste0(datap,"GAK_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
gakZmLoss <- read.csv(paste0(datap,"GAK_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
## HI
hiDet <- read.csv(paste0(datap,"HI_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
hiTB <- read.csv(paste0(datap,"HI_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
hiTP <- read.csv(paste0(datap,"HI_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
hiZmeso <- read.csv(paste0(datap,"HI_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
hiZmLoss <- read.csv(paste0(datap,"HI_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
## CHK
chkDet <- read.csv(paste0(datap,"CHK_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
chkTB <- read.csv(paste0(datap,"CHK_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
chkTP <- read.csv(paste0(datap,"CHK_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
chkZmeso <- read.csv(paste0(datap,"CHK_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
chkZmLoss <- read.csv(paste0(datap,"CHK_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
##GMX
gmxDet <- read.csv(paste0(datap,"GMX_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
gmxTB <- read.csv(paste0(datap,"GMX_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
gmxTP <- read.csv(paste0(datap,"GMX_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
gmxZmeso <- read.csv(paste0(datap,"GMX_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
gmxZmLoss <- read.csv(paste0(datap,"GMX_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
## NE
neDet <- read.csv(paste0(datap,"NE_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
neTB <- read.csv(paste0(datap,"NE_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
neTP <- read.csv(paste0(datap,"NE_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
neZmeso <- read.csv(paste0(datap,"NE_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
neZmLoss <- read.csv(paste0(datap,"NE_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
##SE
seDet <- read.csv(paste0(datap,"SE_regress_Det_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
seTB <- read.csv(paste0(datap,"SE_regress_TB_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
seTP <- read.csv(paste0(datap,"SE_regress_TP_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
seZmeso <- read.csv(paste0(datap,"SE_regress_Zmeso_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
seZmLoss <- read.csv(paste0(datap,"SE_regress_ZmLoss_ALLdiv2SD_melt_mat_nu.csv"),sep=",",header = T,stringsAsFactors = F)
...
c5 <- ggplot(data = rcceDet, aes(y=Type, x=Lag, fill=coef)) + 
  ...
  scale_fill_distiller(palette = "RdBu", limit = c(-1.05,1.05),
                       breaks=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0),
                       labels=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0), name="Det\nCoef") +
...
c4 <- ggplot(data = rcceTB, aes(y=Type, x=Lag, fill=coef)) + 
  ...
  scale_fill_distiller(palette = "RdBu", limit = c(-1.05,1.05),
                       breaks=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0),
                       labels=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0), name="TB\nCoef") +
  theme_minimal() + labs(x="")+ labs(y="")+
  #theme(legend.key.height=unit(0.4,'cm'),legend.key.width=unit(0.15, 'cm'))+
  guides(fill = "none")+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, 
...
c1 <- ggplot(data = rcceTP, aes(y=Type, x=Lag, fill=coef)) + 
  ...
  scale_fill_distiller(palette = "RdBu", limit = c(-1.05,1.05),
                       breaks=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0),
                       labels=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0),  name="TP\nCoef") +
...
c2 <- ggplot(data = rcceZmeso, aes(y=Type, x=Lag, fill=coef)) + 
  ...
  scale_fill_distiller(palette = "RdBu", limit = c(-1.05,1.05),
                       breaks=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0),
                       labels=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0), name="Zmeso\nCoef") +
  theme_minimal() + labs(x="")+labs(y="")+
  #theme(legend.key.height=unit(0.4,'cm'),legend.key.width=unit(0.15, 'cm'))+
  guides(fill = "none")+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, 
...
c3 <- ggplot(data = rcceZmLoss, aes(y=Type, x=Lag, fill=coef)) + 
  ...
  scale_fill_distiller(palette = "RdBu", limit = c(-1.05,1.05),
                       breaks=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0),
                       labels=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0), name="ZmLoss\nCoef") +
  theme_minimal() + labs(x="")+labs(y="")+
  #theme(legend.key.height=unit(0.4,'cm'),legend.key.width=unit(0.15, 'cm'))+
  guides(fill = "none")+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, 
...
n3 <- ggplot(data = rneZmLoss, aes(y=Type, x=Lag, fill=coef)) + 
  ...
  scale_fill_distiller(palette = "RdBu", limit = c(-1.05,1.05),
                       breaks=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0),
                       labels=c(-1.0,-0.67,-0.33,0,0.33,0.67,1.0), name="Coef") +
  theme_minimal() + labs(x="Lag (y)")+labs(y="")+
  #theme(legend.key.height=unit(0.4,'cm'),legend.key.width=unit(0.15, 'cm'))+
  guides(fill = "none")+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, 
...
png(paste0(figp,'Heatmaps_CCE_EBS_GAK_NE_coef_inputs_fntype2_nu_ALLdiv2SD.png'), 
...
png(paste0(figp,'Heatmaps_AI_GAK_HI_GMX_SE_coef_inputs_fntypes_nu_ALLdiv2SD.png'), 
    width = 7.5*300,        # 5 x 300 pixels
    height = 7.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
