...
%%
writetable(Ftab1,[spath,'LMEs_corr_driver_maxcorr_F_gam.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_corr_driver_maxcorr_P_gam.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_corr_driver_maxcorr_D_gam.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'LMEs_corr_driver_maxcorr_A_gam.csv'],...
    'Delimiter',',','WriteRowNames',true);


save([spath,'LMEs_gam_corr_driver_maxcorrs.mat'],...
