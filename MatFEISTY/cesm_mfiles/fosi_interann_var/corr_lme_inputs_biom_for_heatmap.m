...
writetable(Ftab,[rpath,'LME_corr_maxlag_driver_biom_F.csv'],...
    'Delimiter',',');
writetable(Ptab,[rpath,'LME_corr_maxlag_driver_biom_P.csv'],...
    'Delimiter',',');
writetable(Dtab,[rpath,'LME_corr_maxlag_driver_biom_D.csv'],...
    'Delimiter',',');
writetable(Atab,[rpath,'LME_corr_maxlag_driver_biom_A.csv'],...
    'Delimiter',',');

save([rpath,'LME_corr_maxlag_driver_biom.mat'],'lid',...
