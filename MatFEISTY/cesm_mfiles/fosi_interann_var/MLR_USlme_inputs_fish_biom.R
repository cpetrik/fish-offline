...
for (i in 1:nlme) {
  ...
  #print(fcombo)
  #head(fcombo)
  #subset(fcombo, delta < 3)
  # select models using Royall's 1/8 rule for strength of evidence
  # IMPORTANT: Weights have been renormalized!!
  subset(fcombo, 1/8 < weight/max(fcombo$weight))
  ## Coefficients of all models and best
  #coefTable(fcombo)
  coefTable(fcombo)[1]
  summary(get.models(fcombo, 1)[[1]])
...
write.table(fcoef,paste0(datar,"USlme_F_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"USlme_P_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"USlme_D_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"USlme_A_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(bcoef,paste0(datar,"USlme_B_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)

write.table(fpval,paste0(datar,"USlme_F_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(ppval,paste0(datar,"USlme_P_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(dpval,paste0(datar,"USlme_D_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(apval,paste0(datar,"USlme_A_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(bpval,paste0(datar,"USlme_B_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
...
png(paste0(figp,'Heatmaps_USLME_mlr_coeffs_ALLdiv2SD.png'), 
...
png(paste0(figp,"hclust_wardD_heatmap_USLME_A_mlr_coeffs_ALLdiv2SD.png"),    # create PNG for the heat map        
...
png(paste0(figp,"hclust_wardD_heatmap_USLME_F_mlr_coeffs_ALLdiv2SD.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_USLME_P_mlr_coeffs_ALLdiv2SD.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_USLME_D_mlr_coeffs_ALLdiv2SD.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_USLME_B_mlr_coeffs_ALLdiv2SD.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
