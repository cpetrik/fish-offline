...
fcoef <- read.csv(paste0(datar,"LMEs_mlr_nu_drivers_ALLdiv2SD_alllags3_noint_reduc_F.csv"),sep=",",header = T,stringsAsFactors = F)
pcoef <- read.csv(paste0(datar,"LMEs_mlr_nu_drivers_ALLdiv2SD_alllags3_noint_reduc_P.csv"),sep=",",header = T,stringsAsFactors = F)
dcoef <- read.csv(paste0(datar,"LMEs_mlr_nu_drivers_ALLdiv2SD_alllags3_noint_reduc_D.csv"),sep=",",header = T,stringsAsFactors = F)
acoef <- read.csv(paste0(datar,"LMEs_mlr_nu_drivers_ALLdiv2SD_alllags3_noint_reduc_A.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,"reduc_heatmap_LME_Anu_mlr_coeffs_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map
...
png(paste0(figp,"reduc_heatmap_LME_Fnu_mlr_coeffs_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
png(paste0(figp,"reduc_heatmap_LME_Pnu_mlr_coeffs_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
png(paste0(figp,"reduc_heatmap_LME_Dnu_mlr_coeffs_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)
...
fcoef70 <- subset(fcoef, R2 >= 0.5)
pcoef70 <- subset(pcoef, R2 >= 0.5)
dcoef70 <- subset(dcoef, R2 >= 0.5)
acoef70 <- subset(acoef, R2 >= 0.5)
...
png(paste0(figp,"reduc_heatmap_LME_Anu_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_Fnu_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_Pnu_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
# Color the branches based on the clusters:
ddfish <- color_branches(ddfish,k=6) #
ddend_7 <- cutree(ddfish, k=6)
dcoef70$Cluster <- ddend_7
# reduce the size of the labels:
ddfish <- set(ddfish, "labels_cex", 0.8)

png(paste0(figp,"reduc_heatmap_LME_Dnu_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
### Save clustering
write.table(fcoef,paste0(datar,"LME_Fnu_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_Pnu_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_Dnu_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_Anu_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_cluster.csv"),sep=",",row.names=F)
