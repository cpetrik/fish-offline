% Map clusters of driver-fish single linear regressions
% For all 63 LMEs
...
load([spath,'LME_biom_sig_SLR_coeffs_cluster.mat'],'biomA','ctex','stex')
load([spath,'LME_nu_sig_SLR_coeffs_cluster.mat'],'prodA')
...
writetable(Atab,[spath,'LME_biom_nu_A_SLR_coeffs_cluster_matched.csv'])
...
%% save
save([spath,'LME_biom_nu_A_SLR_coeffs_cluster_matched.mat'])
...
colormap(mcol)
clim([1 3])
colorbar('southoutside','Ticks',1:3,'TickLabels',1:3,'Direction','reverse')
title('Prod')

print('-dpng',[ppath 'Map_LMEs_driver_biom_nu_A_SLR_coeffs_cluster_Match.png'])
...
colorbar('Position',[0.88 0.1 0.03 0.7],'Ticks',1:3,'TickLabels',alltex,...
    'Direction','reverse')
print('-dpng',[ppath 'Map_LMEs_driver_biom_nu_A_SLR_coeffs_cluster.png'])
