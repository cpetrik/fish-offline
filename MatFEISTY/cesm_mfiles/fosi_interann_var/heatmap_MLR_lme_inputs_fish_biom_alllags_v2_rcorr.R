...
fcoef <- read.csv(paste0(datar,"LME_F_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.csv"),sep=",",header = T,stringsAsFactors = F)
pcoef <- read.csv(paste0(datar,"LME_P_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.csv"),sep=",",header = T,stringsAsFactors = F)
dcoef <- read.csv(paste0(datar,"LME_D_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.csv"),sep=",",header = T,stringsAsFactors = F)
acoef <- read.csv(paste0(datar,"LME_A_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.csv"),sep=",",header = T,stringsAsFactors = F)
bcoef <- read.csv(paste0(datar,"LME_B_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,"hclust_wardD_heatmap_LME_A_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.png"),    # create PNG for the heat map        
...
png(paste0(figp,"hclust_wardD_heatmap_LME_F_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_P_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_D_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_B_mlr_coeffs_Rcorr_ALLdiv2SD_alllags_v2.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
