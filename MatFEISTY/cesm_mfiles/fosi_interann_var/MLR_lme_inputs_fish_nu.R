...
write.table(fcoef,paste0(datar,"LME_Fnu_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_Pnu_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_Dnu_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_Anu_mlr_coeffs_ALLdiv2SD.csv"),sep=",",row.names=F)

write.table(fpval,paste0(datar,"LME_Fnu_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(ppval,paste0(datar,"LME_Pnu_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(dpval,paste0(datar,"LME_Dnu_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
write.table(apval,paste0(datar,"LME_Anu_mlr_pvals_ALLdiv2SD.csv"),sep=",",row.names=F)
