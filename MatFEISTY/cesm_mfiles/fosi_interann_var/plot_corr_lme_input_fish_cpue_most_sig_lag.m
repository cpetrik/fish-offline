...
load([spath,'LMEs_corr_cpue_driver_maxcorrs.mat'])
...
xlabel('LME')
ylabel('CPUE Corr Coeff')
title('All fishes')
print('-dpng',[ppath 'Bar_LMEs_cpue_driver_maxcorr_allfish.png'])
...
stamp('CPUE corr')
print('-dpng',[ppath 'Map_LMEs_cpue_driver_maxcorr_allfish.png'])
