...
load([spath 'LME_gam_alltypes_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.mat'])
...
%%
writetable(Ftab1,[spath,'LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc_F.csv'],...
    'Delimiter',',','WriteRowNames',false);
writetable(Ptab1,[spath,'LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc_P.csv'],...
    'Delimiter',',','WriteRowNames',false);
writetable(Dtab1,[spath,'LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc_D.csv'],...
    'Delimiter',',','WriteRowNames',false);
writetable(Atab1,[spath,'LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc_A.csv'],...
    'Delimiter',',','WriteRowNames',false);


save([spath,'LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc.mat'],...
