# Cluster results of Mult linear regression of forcing on fish biomass
...
fdend_4 <- cutree(fdfish, k=4)
fcoef$Cluster <- fdend_4
...
ddend_4 <- cutree(ddfish, k=4)
dcoef$Cluster <- ddend_4
...
write.table(fcoef,paste0(datar,"LME_F_mlr_coeffs_ALLdiv2SD_alllags_reduc_cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_P_mlr_coeffs_ALLdiv2SD_alllags_reduc_cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_D_mlr_coeffs_ALLdiv2SD_alllags_reduc_cluster.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_A_mlr_coeffs_ALLdiv2SD_alllags_reduc_cluster.csv"),sep=",",row.names=F)
write.table(bcoef,paste0(datar,"LME_B_mlr_coeffs_ALLdiv2SD_alllags_reduc_cluster.csv"),sep=",",row.names=F)
