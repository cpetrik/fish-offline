...
fcoef <- read.csv(paste0(datar,"LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc_F.csv"),sep=",",header = T,stringsAsFactors = F)
pcoef <- read.csv(paste0(datar,"LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc_P.csv"),sep=",",header = T,stringsAsFactors = F)
dcoef <- read.csv(paste0(datar,"LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc_D.csv"),sep=",",header = T,stringsAsFactors = F)
acoef <- read.csv(paste0(datar,"LMEs_mlr_gam_drivers_ALLdiv2SD_alllags3_noint_reduc_A.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,"reduc_heatmap_LME_A_gam_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_4clus.png"),    # create PNG for the heat map        
...
png(paste0(figp,"reduc_heatmap_LME_F_gam_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_P_gam_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_D_gam_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
### Save clustering
write.table(fcoef,paste0(datar,"LME_F_gam_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_075_4cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_P_gam_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_075_4cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_D_gam_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_075_4cluster.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_A_gam_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_075_6cluster.csv"),sep=",",row.names=F)
