...
for L = 1:length(lid)
    ...
    eval(['save(''' [fpath 'FOSI_prod_regress_drivers_div2SD.mat'] ''',''' ['Cmat_nosize_' ilme] ''',''-append'')']);
    eval(['save(''' [fpath 'FOSI_prod_regress_drivers_div2SD.mat'] ''',''' ['Pmat_nosize_' ilme] ''',''-append'')']);
