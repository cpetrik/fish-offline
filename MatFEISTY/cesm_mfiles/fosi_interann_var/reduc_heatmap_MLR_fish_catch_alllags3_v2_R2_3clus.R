# Heatmaps of Mult linear regression of forcing on FishMIP Catch
...
fcoef <- read.csv(paste0(datar,"LMEs_mlr_catch_drivers_ALLdiv2SD_alllags3_noint_reduc_F.csv"),sep=",",header = T,stringsAsFactors = F)
pcoef <- read.csv(paste0(datar,"LMEs_mlr_catch_drivers_ALLdiv2SD_alllags3_noint_reduc_P.csv"),sep=",",header = T,stringsAsFactors = F)
dcoef <- read.csv(paste0(datar,"LMEs_mlr_catch_drivers_ALLdiv2SD_alllags3_noint_reduc_D.csv"),sep=",",header = T,stringsAsFactors = F)
acoef <- read.csv(paste0(datar,"LMEs_mlr_catch_drivers_ALLdiv2SD_alllags3_noint_reduc_A.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,"reduc_heatmap_LME_A_catch_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_6clus.png"),    # create PNG for the heat map        
...
png(paste0(figp,"reduc_heatmap_LME_F_catch_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_5clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_P_catch_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_D_catch_mlr_coeffs_R2_025_ALLdiv2SD_alllags3_6clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
## Forage
fdend_k <- cutree(fdfish, k=5)
fcoef25$Cluster <- fdend_k

## Lg Pel
pdend_k <- cutree(pdfish, k=3)
...
write.table(fcoef,paste0(datar,"LME_FishMIP_catch_F_mlr_coeffs_reduc_ALLdiv2SD_alllags_R2_025_5cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_FishMIP_catch_P_mlr_coeffs_reduc_ALLdiv2SD_alllags_R2_025_3cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_FishMIP_catch_D_mlr_coeffs_reduc_ALLdiv2SD_alllags_R2_025_6cluster.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_FishMIP_catch_A_mlr_coeffs_reduc_ALLdiv2SD_alllags_R2_025_6cluster.csv"),sep=",",row.names=F)
