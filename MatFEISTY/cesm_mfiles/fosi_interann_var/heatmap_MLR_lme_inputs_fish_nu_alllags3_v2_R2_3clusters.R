...
png(paste0(figp,"hclust_wardD_heatmap_LME_Anu_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_Fnu_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_Pnu_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_Dnu_mlr_coeffs_R2_07_ALLdiv2SD_alllags3_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
### Save clustering
write.table(fcoef,paste0(datar,"LME_Fnu_mlr_coeffs_ALLdiv2SD_alllags3_R2_07_3cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_Pnu_mlr_coeffs_ALLdiv2SD_alllags3_R2_07_3cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_Dnu_mlr_coeffs_ALLdiv2SD_alllags3_R2_07_3cluster.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_Anu_mlr_coeffs_ALLdiv2SD_alllags3_R2_07_3cluster.csv"),sep=",",row.names=F)
