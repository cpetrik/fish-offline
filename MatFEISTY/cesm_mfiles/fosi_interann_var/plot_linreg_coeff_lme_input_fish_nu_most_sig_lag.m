% Plot max SLR coeff of driver-fish nu corrs
% For all 63 LMEs
...
load([spath,'LMEs_SLR_nu_driver_maxR2s.mat']) %table of coeff of best driver at best lag
...
xlabel('LME')
ylabel('LR Coeff')
title('Production LR All fishes')
stamp('Nu LR')
print('-dpng',[ppath 'Bar_LMEs_nu_driver_SLR_maxR2s_allfish.png'])
...
print('-dpng',[ppath 'Bar_LMEs_nu_driver_SLR_maxR2s_fntypes.png'])
...
stamp('Nu LR')
print('-dpng',[ppath 'Map_LMEs_nu_driver_SLR_maxR2s_allfish_dominant.png'])
...
subplot('Position',[0.33 0.10 0.32 0.4]) %All
axesm ('Robinson','MapLatLimit',clatlim,'MapLonLimit',clonlim,'frame','on',...
    'Grid','off','FLineWidth',1)
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
hold on
...
title('Demersals')
stamp('Nu LR')
print('-dpng',[ppath 'Map_LMEs_nu_driver_SLR_maxR2s_fntypes_dominant.png'])
...
colorbar
clim([-1 1])
title('Prod LR coeff All fishes')
stamp('Prod LR')
print('-dpng',[ppath 'Map_LMEs_driver_nu_SLR_maxR2s_allfish_coeff.png'])
...
stamp('Prod LR')
print('-dpng',[ppath 'Map_LMEs_driver_nu_SLR_maxR2s_allfish_R2.png'])
