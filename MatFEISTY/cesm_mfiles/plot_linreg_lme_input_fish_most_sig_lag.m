...
load([spath,'LMEs_regress_driver_div2SD_maxcoefs.mat'])
...
ylabel('Coeff')
title('All fishes')
print('-dpng',[ppath 'Bar_LMEs_driver_corrcoef_allfish.png'])
...
print('-dpng',[ppath 'Bar_LMEs_driver_corrcoef_fntypes.png'])
...
title('All fishes')
print('-dpng',[ppath 'Map_LMEs_driver_corrcoef_allfish.png'])
...
title('Benthos')
print('-dpng',[ppath 'Map_LMEs_driver_corrcoef_fntypes.png'])
