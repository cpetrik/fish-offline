...
mod = 'v15_All_fish03'; %'v15_obsfish', v15_All_fish03
...
%%
writetable(Ftab1,[spath,'LMEs_corr_driver_ZlDet_maxcorr_Fnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_corr_driver_ZlDet_maxcorr_Pnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_corr_driver_ZlDet_maxcorr_Dnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'LMEs_corr_driver_ZlDet_maxcorr_Anu.csv'],...
    'Delimiter',',','WriteRowNames',true);


save([spath,'LMEs_nu_corr_driver_ZlDet_maxcorrs.mat'],...
