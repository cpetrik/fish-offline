...
for L = 1:length(lid)
    ...
    %%
    %save([spath,ilme,'_regress_drivers_div2SD_0_5_lag_prod.mat'])
...
%%
writetable(Ftab1,[spath,'LMEs_regress_driver_div2SD_maxcoef_Fprod.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_regress_driver_div2SD_maxcoef_Pprod.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_regress_driver_div2SD_maxcoef_Dprod.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'LMEs_regress_driver_div2SD_maxcoef_Aprod.csv'],...
    'Delimiter',',','WriteRowNames',true);


save([spath,'LMEs_prod_regress_driver_div2SD_maxcoefs.mat'],...
