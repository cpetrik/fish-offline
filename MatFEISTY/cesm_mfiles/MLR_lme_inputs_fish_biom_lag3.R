...
Flag <- read.csv(paste0(datar,"LMEs_regress_drivers_ALLdiv2SD_siglag3_F.csv"),sep=",",header = T,stringsAsFactors = F)
Plag <- read.csv(paste0(datar,"LMEs_regress_drivers_ALLdiv2SD_siglag3_P.csv"),sep=",",header = T,stringsAsFactors = F)
Dlag <- read.csv(paste0(datar,"LMEs_regress_drivers_ALLdiv2SD_siglag3_D.csv"),sep=",",header = T,stringsAsFactors = F)
Alag <- read.csv(paste0(datar,"LMEs_regress_drivers_ALLdiv2SD_siglag3_A.csv"),sep=",",header = T,stringsAsFactors = F)
Blag <- read.csv(paste0(datar,"LMEs_regress_drivers_ALLdiv2SD_siglag3_B.csv"),sep=",",header = T,stringsAsFactors = F)
...
write.table(fcoef,paste0(datar,"LME_F_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_P_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_D_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_A_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
write.table(bcoef,paste0(datar,"LME_B_mlr_coeffs_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)

write.table(fpval,paste0(datar,"LME_F_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
write.table(ppval,paste0(datar,"LME_P_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
write.table(dpval,paste0(datar,"LME_D_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
write.table(apval,paste0(datar,"LME_A_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
write.table(bpval,paste0(datar,"LME_B_mlr_pvals_ALLdiv2SD_lag3.csv"),sep=",",row.names=F)
...
png(paste0(figp,"hclust_wardD_heatmap_LME_A_mlr_coeffs_ALLdiv2SD_lag3.png"),    # create PNG for the heat map        
...
png(paste0(figp,"hclust_wardD_heatmap_LME_F_mlr_coeffs_ALLdiv2SD_lag3.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_P_mlr_coeffs_ALLdiv2SD_lag3.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_D_mlr_coeffs_ALLdiv2SD_lag3.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"hclust_wardD_heatmap_LME_B_mlr_coeffs_ALLdiv2SD_lag3.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
