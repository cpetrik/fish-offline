...
png(paste0(figp,"reduc_heatmap_LME_A_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_4clus.png"),    # create PNG for the heat map        
...
png(paste0(figp,"reduc_heatmap_LME_F_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_P_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_4clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_D_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"reduc_heatmap_LME_B_mlr_coeffs_R2_05_ALLdiv2SD_alllags3_5clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
write.table(fcoef,paste0(datar,"LME_F_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_3cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_P_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_4cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_D_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_3cluster.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_A_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_4cluster.csv"),sep=",",row.names=F)
write.table(bcoef,paste0(datar,"LME_B_mlr_coeffs_reduc_ALLdiv2SD_alllags3_R2_05_5cluster.csv"),sep=",",row.names=F)
