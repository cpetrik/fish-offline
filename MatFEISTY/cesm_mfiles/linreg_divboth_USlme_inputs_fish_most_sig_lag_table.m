...
%%
writetable(Ftab1,[spath,'USLMEs_regress_driver_ALLdiv2SD_maxcoef_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'USLMEs_regress_driver_ALLdiv2SD_maxcoef_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'USLMEs_regress_driver_ALLdiv2SD_maxcoef_D.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'USLMEs_regress_driver_ALLdiv2SD_maxcoef_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Btab1,[spath,'USLMEs_regress_driver_ALLdiv2SD_maxcoef_B.csv'],...
    'Delimiter',',','WriteRowNames',true);
