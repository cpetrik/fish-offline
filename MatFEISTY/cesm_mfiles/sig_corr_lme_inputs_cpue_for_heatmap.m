...
writetable(Ftab,[rpath,'LME_sig_corr_maxlag_driver_cpue_F.csv'],...
    'Delimiter',',');
writetable(Ptab,[rpath,'LME_sig_corr_maxlag_driver_cpue_P.csv'],...
    'Delimiter',',');
writetable(Dtab,[rpath,'LME_sig_corr_maxlag_driver_cpue_D.csv'],...
    'Delimiter',',');
writetable(Atab,[rpath,'LME_sig_corr_maxlag_driver_cpue_A.csv'],...
    'Delimiter',',');

save([rpath,'LME_sig_corr_maxlag_driver_cpue.mat'],'lid',...
