...
load([spath,'LMEs_corr_nu_drivers_0_5_lag.mat'])
...
for j = 1:length(tanom)
    ...
    for i=1:length(lid)
        ...
        Fcorr(id) = squeeze(FtabC(j,1,i));
        Pcorr(id) = squeeze(PtabC(j,1,i));
        Dcorr(id) = squeeze(DtabC(j,1,i));
        Acorr(id) = squeeze(AtabC(j,1,i));
    end
    ...
    print('-dpng',[ppath 'Map_LMEs_',tanom{j},'_corr_nu_allfish.png'])
    ...
    c.Label.String = ['Corr with ' tanom{j}];
    print('-dpng',[ppath 'Map_LMEs_',tanom{j},'_corr_nu_fntypes.png'])
...
print(f3,'-dpng',[ppath 'Map_LMEs_nu_drivers_corr_F.png'])
print(f4,'-dpng',[ppath 'Map_LMEs_nu_drivers_corr_P.png'])
print(f5,'-dpng',[ppath 'Map_LMEs_nu_drivers_corr_D.png'])
print(f6,'-dpng',[ppath 'Map_LMEs_nu_drivers_corr_A.png'])
