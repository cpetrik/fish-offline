...
for (i in 1:nlme) {
  ...
  pmod <- lm(Fish ~ TP1+TP2 + TB1+TB2 + Det1+Det2 + ZmLoss1+ZmLoss2 + 
  ...
  dmod <- lm(Fish ~ TP1+TP2 + TB1+TB2 + Det1+Det2 + ZmLoss1+ZmLoss2 + 
               Det1*ZmLoss1 + Det2*ZmLoss2 + 
               TP1*ZmLoss1 + TP2*ZmLoss2 + 
  ...
  amod <- lm(Fish ~ TP1+TP2 + TB1+TB2 + Det1+Det2 + ZmLoss1+ZmLoss2 + 
               Det1*ZmLoss1 + Det2*ZmLoss2 + 
               TP1*ZmLoss1 + TP2*ZmLoss2 + 
  ...
  bmod <- lm(Bent ~ TP0+TP1 + TB0+TB1 + Det0+Det1 + ZmLoss0+ZmLoss1 + 
               Det0*ZmLoss0 + Det1*ZmLoss1 + 
               TP0*ZmLoss0 + TP1*ZmLoss1 + 
...
write.table(fcoef,paste0(datar,"LME_F_mlr_coeffs_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_P_mlr_coeffs_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_D_mlr_coeffs_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_A_mlr_coeffs_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
write.table(bcoef,paste0(datar,"LME_B_mlr_coeffs_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)

write.table(fpval,paste0(datar,"LME_F_mlr_pvals_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
write.table(ppval,paste0(datar,"LME_P_mlr_pvals_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
write.table(dpval,paste0(datar,"LME_D_mlr_pvals_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
write.table(apval,paste0(datar,"LME_A_mlr_pvals_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
write.table(bpval,paste0(datar,"LME_B_mlr_pvals_ALLdiv2SD_alllags_v2.csv"),sep=",",row.names=F)
