...
% CESM Spinup first year of High Res
...
harv = 'hr_cce_All_fish03';
mod  = 'hr_cce_All_fish03';
...
load([fpath 'Means_Spinup_' harv '_' cfile '.mat']);
...
stamp('')
print('-dpng',[ppath 'Spinup_',mod,'_BENT.png'])
...
stamp('')
print('-dpng',[ppath 'Spinup_',mod,'_All_subplot_BP50.png'])
...
title('log10 mean All fishes (g m^-^2)')
stamp('')
print('-dpng',[ppath 'Spinup_',mod,'_All_subplot_YGB10.png'])
...
stamp('')
print('-dpng',[ppath 'Spinup_',mod,'_ratios_subplot.png'])
