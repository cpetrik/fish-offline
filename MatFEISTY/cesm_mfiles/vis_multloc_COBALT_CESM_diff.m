...
stamp('')
print('-dpng',[ppath 'CESM_COBALT_' harv '_global_diff_types.png'])
...
title('CESM - COBALT All');
stamp('')
print('-dpng',[ppath 'CESM_COBALT_' harv '_global_pdiff_types.png'])
...
title('CESM - COBALT B');
stamp('')
print('-dpng',[ppath 'CESM_COBALT_' harv '_global_diffs_B.png'])
