...
mod = 'v15_All_fish03'; % 'v15_All_fish03','v15_obsfish'
...
%%
cname = {'TP','TB','Det','ZmLoss','ZmL:Det','LME'};
...
writetable(Ftab,[rpath,'LME_sig_corr_maxlag_driver_ZlDet_biom_F.csv'],...
    'Delimiter',',');
writetable(Ptab,[rpath,'LME_sig_corr_maxlag_driver_ZlDet_biom_P.csv'],...
    'Delimiter',',');
writetable(Dtab,[rpath,'LME_sig_corr_maxlag_driver_ZlDet_biom_D.csv'],...
    'Delimiter',',');
writetable(Atab,[rpath,'LME_sig_corr_maxlag_driver_ZlDet_biom_A.csv'],...
    'Delimiter',',');

save([rpath,'LME_sig_corr_maxlag_driver_ZlDet_biom.mat'],'lid',...
