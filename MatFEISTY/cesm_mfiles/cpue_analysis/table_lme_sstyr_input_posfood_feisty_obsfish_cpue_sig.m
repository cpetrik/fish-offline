...
%%  ---------------- sat --------------------------
load([spath,'LMEs_corr_cpue_sstyrs_maxcorr_posfood.mat'])
...
%%  ---------------- inputss --------------------------
load([spath,'LMEs_corr_cpue_sstyrs_driver_maxcorr_posfood.mat'])
...
%%  ---------------- constfish --------------------------
load([spath,'LMEs_corr_cpue_sstyrs_inputs_feisty_maxcorr_posfood.mat'])
...
%%  ---------------- obsfish --------------------------
load([spath,'LMEs_corr_cpue_sstyrs_driver_obsfish_maxcorr_posfood.mat'])
...
% I feel like corrs with sat shouldn't incr when adding inputss

%%
lname = cellstr(num2str(lid));
cname = {'Sat','Sat-OBGC','Sat-OBGC-FishC','Sat-OBGC-FishO'};
rname = {'SST','Chl','TP','TB','Det','ZmLoss','Biom','Prod'};
...
%%
writetable(TabA,[spath,'Num_LMEs_corr_cpue_sstyrs_inputs_feisty_maxcorr_posfood_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabF,[spath,'Num_LMEs_corr_cpue_sstyrs_inputs_feisty_maxcorr_posfood_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabP,[spath,'Num_LMEs_corr_cpue_sstyrs_inputs_feisty_maxcorr_posfood_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabD,[spath,'Num_LMEs_corr_cpue_sstyrs_inputs_feisty_maxcorr_posfood_D.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'Num_LMEs_corr_cpue_sstyrs_inputs_feisty_maxcorr_posfood.mat'],...
    'matF','matP','matD','matA',...
