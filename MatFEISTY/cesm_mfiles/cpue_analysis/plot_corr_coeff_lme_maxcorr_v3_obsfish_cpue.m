% Plot corr coeffs of driver-cpue corrs
% Lag with max R2
% For all 63 LMEs
% Only positive corrs with prey, fish
% Use calc corr of cpue with forcing
...
%%
load([spath 'LMEs_corr_cpue_satyrs_obsfish_lags.mat'])
ftex = tanom;
%dim: LME x driver x lags
...
for j=1:2 %pos & neg w/temp
    ...
    print('-dpng',[ppath 'Map_LMEs_corr_coeff_v3_',tanom{j},'_cpue_fntypes_obsfish.png'])
end
...
for j=3:6
    ...
    title(['corr CPUE All with ' tanom{j}])
    %stamp('')
    print('-dpng',[ppath 'Map_LMEs_pos_corr_coeff_v3_',tanom{j},'_cpue_fntypes_obsfish.png'])
    ...
    % title(['corr CPUE All with ' tanom{j}])
    % %stamp('')
    % print('-dpng',[ppath 'Map_LMEs_pos_corr_coeff_v3_',tanom{j},'_cpue_all_obsfish.png'])
...
for j=5:6
    ...
    %stamp('')
    print('-dpng',[ppath 'Map_LMEs_pos_corr_coeff_v3_',tanom{j},'_cpue_fntypes_R2_obsfish.png'])
...
set(gcf,'renderer','painters')
title('Det')
print('-dpng',[ppath 'Map_LMEs_corr_coeff_v3_drivers_posfood_cpue_allfish_obsfish.png'])
...
print('-dpng',[ppath 'Map_LMEs_pos_corr_coeff_v3_drivers_cpue_allfish_obsfish.png'])
