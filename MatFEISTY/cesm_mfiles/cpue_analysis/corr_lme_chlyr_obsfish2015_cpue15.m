...
% Biomass
load([fpath 'FEISTY_FOSI_',mod,'_lme_biom_ann_mean_anoms_1997_2015.mat'],'eyr',...
    'aba15','abd15','abf15','abp15');

% Nu
load([fpath 'FEISTY_FOSI_',mod,'_lme_nu_ann_mean_anoms_1997_2015.mat'],...
...
%%
save([spath,'LMEs_corr_cpue_chlyrs15_obsfish2015_lags.mat'],...
