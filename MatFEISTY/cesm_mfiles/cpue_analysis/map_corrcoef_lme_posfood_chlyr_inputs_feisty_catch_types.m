...
print('-dpng',[ppath 'Map_LMEs_chlyr_catch_driver_feisty_corrcoef_All.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_chlyr_catch_driver_feisty_corrcoef_F.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_chlyr_catch_driver_feisty_corrcoef_P.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_chlyr_catch_driver_feisty_corrcoef_D.png'])
