...
%%
load([spath 'LMEs_corr_catch_sstyrs15_inputs_feisty_mostsiglag_posfood.mat'])
...
LAtab2(:,8:9,:) = LAtab(:,6:7,:);
LFtab2(:,8:9,:) = LFtab(:,6:7,:);
LPtab2(:,8:9,:) = LPtab(:,6:7,:);
LDtab2(:,8:9,:) = LDtab(:,6:7,:);
...
print('-dpng',[ppath 'Map_LMEs_sstyrs15_catch_driver_feisty_obsfish2015_corrcoef_All.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_sstyrs15_catch_driver_feisty_obsfish2015_corrcoef_F.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_sstyrs15_catch_driver_feisty_obsfish2015_corrcoef_P.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_sstyrs15_catch_driver_feisty_obsfish2015_corrcoef_D.png'])
