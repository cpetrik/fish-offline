...
line(dyr1,adet15(12,(1:(end-1))),'color',cdet,'LineWidth',1.5,'Parent',h1); hold on;
line(yyr,aba15(12,:),'color',cbio,'LineWidth',1.5,'Parent',h2);
line(yyr,abf15(12,:),'color',cf,'LineWidth',1.5,'Parent',h3);
%line(yyr,abp15(12,:),'color',cp,'LineWidth',1,'Parent',h4);
xlabel(h1,'Year');

line(yyr,aa_cpue97(12,:),'color','k','LineWidth',1.5,'Parent',h4); 
...
text(2001,-0.0002,'r_{Det} = ','color',cdet)
text(2001,-0.0003,'r_{BioA} = ','color',cbio)
text(2001,-0.0004,'r_{BioF} = ','color',cf)
...
line(dyr1,azlos15(26,(1:(end-1))),'color',czm,'LineWidth',1.5,'Parent',h1); hold on;
line(cyr1,abf15(26,(2:end)),'color',cf,'LineWidth',1.5,'Parent',h2); 
line(cyr1,abd15(26,(2:end)),'color',cd,'LineWidth',1.5,'Parent',h3); 
xlabel(h1,'Year');

line(cyr1,aa_cpue97(26,(2:end)),'color','k','LineWidth',1.5,'Parent',h4); 
...
line(dyr1,adet15(54,(1:(end-1))),'color',cdet,'LineWidth',1.5,'Parent',h1); hold on;
line(cyr1,abd15(54,(2:end)),'color',cd,'LineWidth',1.5,'Parent',h2); 
xlabel(h1,'Year');

line(cyr1,aa_cpue97(54,(2:end)),'color','k','LineWidth',1.5,'Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 54, Det-1')
