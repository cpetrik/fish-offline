...
% Restricted analysis to sst yrs 1982-2015
% Const effort
...
%%
load([spath 'LMEs_corr_cpue_sstyrs15_inputs_feisty_mostsiglag_posfood.mat'])
...
%%
load([spath 'LMEs_corr_cpue_sstyrs15_inputs_obsfish2015_mostsiglag_posfood.mat'])

LAmat2(:,8:9,:) = LAtab(:,6:7,:);
LFmat2(:,8:9,:) = LFtab(:,6:7,:);
LPmat2(:,8:9,:) = LPtab(:,6:7,:);
LDmat2(:,8:9,:) = LDtab(:,6:7,:);

tanom2 = {'TP','TB','Det','ZmLoss','SST','CBiom','CProd','OBiom','OProd'};
...
print('-dpng',[ppath 'Map_LMEs_sstyrs15_cpue15_driver_feisty_obsfish2015_corrcoef_All.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_sstyrs15_cpue15_driver_feisty_obsfish2015_corrcoef_F.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_sstyrs15_cpue15_driver_feisty_obsfish2015_corrcoef_P.png'])
...
colorbar('Position',[0.92 0.25 0.025 0.5],'orientation','vertical','AxisLocation','out')
print('-dpng',[ppath 'Map_LMEs_sstyrs15_cpue15_driver_feisty_obsfish2015_corrcoef_D.png'])
