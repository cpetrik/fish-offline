...
for L = 1:length(lid)
    ...
    %% force prey & fish corrs to be pos or zero (3,4)
    AtabC(3,AtabC(3,:)<0) = 0;
    AtabC(4,AtabC(4,:)<0) = 0;
...
%%
writetable(Atab1,[spath,'LMEs_corr_cpue_sstyrs15_inputs_mostsiglag_posfood_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ftab1,[spath,'LMEs_corr_cpue_sstyrs15_inputs_mostsiglag_posfood_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_corr_cpue_sstyrs15_inputs_mostsiglag_posfood_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_corr_cpue_sstyrs15_inputs_mostsiglag_posfood_D.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'LMEs_corr_cpue_sstyrs15_inputs_mostsiglag_posfood.mat'],...
