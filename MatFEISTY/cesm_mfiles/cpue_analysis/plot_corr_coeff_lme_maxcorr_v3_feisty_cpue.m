...
for j=1:2 %pos & neg w/temp
    ...
    print('-dpng',[ppath 'Map_LMEs_corr_coeff_v3_',tanom{j},'_cpue_fntypes.png'])
end
...
for j=3:6
    ...
    title(['corr CPUE All with ' tanom{j}])
    %stamp('')
    print('-dpng',[ppath 'Map_LMEs_pos_corr_coeff_v3_',tanom{j},'_cpue_fntypes.png'])
    ...
    % title(['corr CPUE All with ' tanom{j}])
    % %stamp('')
    % print('-dpng',[ppath 'Map_LMEs_pos_corr_coeff_v3_',tanom{j},'_cpue_all.png'])
...
for j=5:6
    ...
    %stamp('')
    print('-dpng',[ppath 'Map_LMEs_pos_corr_coeff_v3_',tanom{j},'_cpue_fntypes_R2.png'])
...
set(gcf,'renderer','painters')
title('Det')
print('-dpng',[ppath 'Map_LMEs_corr_coeff_v3_drivers_posfood_cpue_allfish.png'])
...
print('-dpng',[ppath 'Map_LMEs_pos_corr_coeff_v3_drivers_cpue_allfish.png'])
