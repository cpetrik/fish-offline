...
%fpath=['/Volumes/MIP/NC/CESM_MAPP/' cfile '/'];
fpath=['/Volumes/petrik-lab/Feisty/NC/CESM_MAPP/' cfile '/FOSI/'];
save([fpath 'FEISTY_FOSI_',mod,'lme_nu_interann_var_1997_2010.mat'],...
    ...
    'lme_f10_cv','lme_p10_cv','lme_d10_cv','lme_a10_cv','eyr','units');

%%
save([fpath 'FEISTY_FOSI_',mod,'lme_nu_ann_mean_anoms_1997_2010.mat'],...
