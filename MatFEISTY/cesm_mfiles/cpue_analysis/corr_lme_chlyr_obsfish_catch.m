...
% Biomass
load([fpath 'FEISTY_FOSI_',mod,'_lme_biom_ann_mean_anoms_1997_2010.mat'],...
...
% Yield/Catch
load([fpath 'FEISTY_FOSI_',mod,'_lme_catch_ann_mean_anoms_1997_2010.mat'],...
...
% Anoms with linear trend removed
load([ypath 'FishMIP_Phase3a_LME_Catch_1997-2010_ann_mean_anoms.mat'],...
...
%%
save([spath,'LMEs_corr_catch_chlyrs_obsfish_lags.mat'],...
