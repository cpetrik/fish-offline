...
%%
tanom = {'TP','TB','Det','ZmLoss','SST','chl','Biom','Prod','Effort'};
...
%%
writetable(Atab1,[spath,'LMEs_corr_catch_satyrs_driver_obsfish_effort_maxcorr_posfood_A2.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ftab1,[spath,'LMEs_corr_catch_satyrs_driver_obsfish_effort_maxcorr_posfood_F2.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_corr_catch_satyrs_driver_obsfish_effort_maxcorr_posfood_P2.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_corr_catch_satyrs_driver_obsfish_effort_maxcorr_posfood_D2.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'LMEs_corr_catch_satyrs_driver_obsfish_effort_maxcorr_posfoods2.mat'],...
