...
writetable(Atab1,[spath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ftab1,[spath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2_D.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2s.mat'],...
    'LFtab','LPtab','LDtab','LAtab',...
    'Ftab1','Ptab1','Dtab1','Atab1','lid');

writetable(Atab1,[dpath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ftab1,[dpath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[dpath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[dpath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2_D.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([dpath,'LMEs_SLR_cpue_driver_feisty_norec_maxR2s.mat'],...
    'LFtab','LPtab','LDtab','LAtab',...
    'Ftab1','Ptab1','Dtab1','Atab1','lid');
