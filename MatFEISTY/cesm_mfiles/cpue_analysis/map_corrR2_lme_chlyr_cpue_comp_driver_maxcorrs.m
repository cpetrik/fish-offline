...
print('-dpng',[ppath 'Map_LMEs_chlyr_cpue_driver_comp_maxcorr_R2_All.png'])
...
colorbar('Position',[0.25 0.055 0.5 0.03],'orientation','horizontal')
title('CPUE Obs Effort')
print('-dpng',[ppath 'Map_LMEs_chlyr_cpue_driver_comp_maxcorr_R2_Forage.png'])
...
colorbar('Position',[0.25 0.055 0.5 0.03],'orientation','horizontal')
title('CPUE Obs Effort')
print('-dpng',[ppath 'Map_LMEs_chlyr_cpue_driver_comp_maxcorr_R2_LgPel.png'])
...
colorbar('Position',[0.25 0.055 0.5 0.03],'orientation','horizontal')
title('CPUE Obs Effort')
print('-dpng',[ppath 'Map_LMEs_chlyr_cpue_driver_comp_maxcorr_R2_Dem.png'])
