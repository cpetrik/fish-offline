...
% see if weaker pos corr with prey than stronger neg corr at diff lag
...
for L = 1:length(lid)
    ...
    %% force prey & fish corrs to be pos or zero (3,4,5,6,8)
    AtabC(3,AtabC(3,:)<0) = 0;
    AtabC(4,AtabC(4,:)<0) = 0;
    AtabC(5,AtabC(5,:)<0) = 0;
    AtabC(6,AtabC(6,:)<0) = 0;
...
writetable(Atab1,[spath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfood_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ftab1,[spath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfood_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfood_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfood_D.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfoods.mat'],...
    'LFtab','LPtab','LDtab','LAtab',...
    'Ftab1','Ptab1','Dtab1','Atab1','lid');

writetable(Atab1,[dpath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfood_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ftab1,[dpath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfood_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[dpath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfood_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[dpath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfood_D.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([dpath,'LMEs_corr_cpue_sat_driver_feisty_norec_maxcorr_posfoods.mat'],...
    'LFtab','LPtab','LDtab','LAtab',...
    'Ftab1','Ptab1','Dtab1','Atab1','lid');
