...
line(yyr,-1*asst15(21,:),'color',csst,'Parent',h1); hold on;
line(yyr,-1*atb15(21,:),'color',ctb,'Parent',h2); 
xlabel(h1,'Year');

line(yyr,aa_cpue97(21,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 21, No lags')
print('-dpng',[ppath 'ts_LME21_CPUE_sig_drivers_nolag.png'])
...
line(yyr,achl15(26,:),'color',cchl,'Parent',h1); hold on;
line(yyr,azlos15(26,:),'color',czm,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(26,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 26, No lags')
print('-dpng',[ppath 'ts_LME26_CPUE_sig_drivers_nolag.png'])
...
line(dyr3,achl15(26,(1:(end-3))),'color',cchl,'Parent',h1); hold on;
...
line(yyr,achl15(29,:),'color',cchl,'Parent',h1); hold on;
line(yyr,atb15(29,:),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(29,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 29, No lags')
print('-dpng',[ppath 'ts_LME29_CPUE_sig_drivers_nolag.png'])
...
line(dyr1,achl15(29,(1:(end-1))),'color',cchl,'Parent',h1); hold on;
line(yyr,atb15(29,:),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(29,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 29, Chl-1, TB0')
print('-dpng',[ppath 'ts_LME29_CPUE_sig_drivers_lags.png'])
...
line(yyr,asst15(31,:),'color',csst,'Parent',h1); hold on;
line(yyr,atp15(31,:),'color',ctp,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(31,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 31, No lags')
print('-dpng',[ppath 'ts_LME31_CPUE_sig_drivers_nolag.png'])
...
line(yyr,asst15(32,:),'color',csst,'Parent',h1); hold on;
line(yyr,atb15(32,:),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(32,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 32, No lags')
print('-dpng',[ppath 'ts_LME32_CPUE_sig_drivers_nolag.png'])
...
line(dyr2,asst15(32,(1:(end-2))),'color',csst,'Parent',h1); hold on;
line(dyr1,atb15(32,(1:(end-1))),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(cyr1,aa_cpue97(32,(2:end)),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 32, SST-2, TB-1')
print('-dpng',[ppath 'ts_LME32_CPUE_sig_drivers_lags.png'])


%% LME 38
% LME slag	sat	dlag	driver	flag	fdriver
% 38	3	Chl	2	    -TP	    2	    Prod
...
h2 = axes('Units','pixels','Position',axesPosition+yWidth.*[-1 0 1 0],...
          ...
          'NextPlot','add');
h3 = axes('Units','pixels','Position',axesPosition+yWidth.*[-2 0 2 0],...
          'Color','none','XColor','k','YColor',cnu,...
          'XLim',xLimit+[2*xOffset 0],'XTick',[],'XTickLabel',[],...
          'NextPlot','add');
h4 = axes('Units','pixels','Position',axesPosition+yWidth.*[-3 0 3 0],...
          'Color','none','XColor','k','YColor','k',...
...
line(yyr,achl15(38,:),'color',cchl,'Parent',h1); hold on;
line(yyr,-1*atp15(38,:),'color',ctp,'Parent',h2); hold on;
line(yyr,ana15(38,:),'color',cnu,'Parent',h3); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(38,:),'color','k','Parent',h4); 
ylabel(h3,'Anomalies')
title('LME 38, No lags')
print('-dpng',[ppath 'ts_LME38_CPUE_sig_drivers_nolag.png'])
...
line(dyr3,achl15(38,(1:(end-3))),'color',cchl,'Parent',h1); hold on;
line(dyr2,-1*atp15(38,(1:(end-2))),'color',ctp,'Parent',h2); hold on;
line(dyr2,ana15(38,(1:(end-2))),'color',cnu,'Parent',h3); hold on;
xlabel(h1,'Year');

line(cyr2,aa_cpue97(38,(3:end)),'color','k','Parent',h4); 
ylabel(h3,'Anomalies')
title('LME 38, Chl-3, TP-2, Prod-2')
print('-dpng',[ppath 'ts_LME38_CPUE_sig_drivers_lags.png'])
...
line(yyr,achl15(42,:),'color',cchl,'Parent',h1); hold on;
line(yyr,-1*atp15(42,:),'color',ctp,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(42,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 42, No lags')
print('-dpng',[ppath 'ts_LME42_CPUE_sig_drivers_nolag.png'])
...
line(dyr2,achl15(42,(1:(end-2))),'color',cchl,'Parent',h1); hold on;
line(dyr1,-1*atp15(42,(1:(end-1))),'color',ctp,'Parent',h2); hold on;
xlabel(h1,'Year');

line(cyr1,aa_cpue97(42,(2:end)),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 42, Chl-2, TP-1')
print('-dpng',[ppath 'ts_LME42_CPUE_sig_drivers_lags.png'])
...
line(yyr,-1*asst15(46,:),'color',csst,'Parent',h1); hold on;
line(yyr,-1*atb15(46,:),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(46,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 46, No lags')
print('-dpng',[ppath 'ts_LME46_CPUE_sig_drivers_nolag.png'])
...
line(dyr2,-1*asst15(46,(1:(end-2))),'color',csst,'Parent',h1); hold on;
line(yyr,-1*atb15(46,:),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(46,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 46, SST-2, TB0')
print('-dpng',[ppath 'ts_LME46_CPUE_sig_drivers_lags.png'])
...
line(yyr,asst15(48,:),'color',csst,'Parent',h1); hold on;
line(yyr,adet15(48,:),'color',cdet,'Parent',h2); hold on;
line(yyr,aba15(48,:),'color',cbio,'Parent',h3); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(48,:),'color','k','Parent',h4); 
ylabel(h3,'Anomalies')
title('LME 48, No lags')
print('-dpng',[ppath 'ts_LME48_CPUE_sig_drivers_nolag.png'])
...
line(yyr,asst15(51,:),'color',csst,'Parent',h1); hold on;
line(yyr,atp15(51,:),'color',ctp,'Parent',h2); hold on;
line(yyr,aba15(51,:),'color',cbio,'Parent',h3); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(51,:),'color','k','Parent',h4); 
ylabel(h3,'Anomalies')
title('LME 51, No lags')
print('-dpng',[ppath 'ts_LME51_CPUE_sig_drivers_nolag.png'])
...
line(dyr3,asst15(51,(1:(end-3))),'color',csst,'Parent',h1); hold on;
line(dyr1,atp15(51,(1:(end-1))),'color',ctp,'Parent',h2); hold on;
line(dyr2,aba15(51,(1:(end-2))),'color',cbio,'Parent',h3); hold on;
xlabel(h1,'Year');

line(cyr1,aa_cpue97(51,(2:end)),'color','k','Parent',h4); 
ylabel(h3,'Anomalies')
title('LME 51, SST-3, TP-1, Bio-2')
print('-dpng',[ppath 'ts_LME51_CPUE_sig_drivers_lags.png'])
...
line(yyr,asst15(53,:),'color',csst,'Parent',h1); hold on;
line(yyr,atb15(53,:),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(53,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 53, No lags')
print('-dpng',[ppath 'ts_LME53_CPUE_sig_drivers_nolag.png'])
...
line(dyr3,asst15(53,(1:(end-3))),'color',csst,'Parent',h1); hold on;
line(dyr3,atb15(53,(1:(end-3))),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(cyr3,aa_cpue97(53,(4:end)),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 53, SST-3, TB-3')
print('-dpng',[ppath 'ts_LME53_CPUE_sig_drivers_lags.png'])
...
line(yyr,achl15(54,:),'color',cchl,'Parent',h1); hold on;
line(yyr,adet15(54,:),'color',cdet,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(54,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 54, No lags')
print('-dpng',[ppath 'ts_LME54_CPUE_sig_drivers_nolag.png'])
...
line(yyr,achl15(58,:),'color',cchl,'Parent',h1); hold on;
line(yyr,-1*atb15(58,:),'color',ctb,'Parent',h2); hold on;
xlabel(h1,'Year');

line(yyr,aa_cpue97(58,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 58, No lags')
print('-dpng',[ppath 'ts_LME58_CPUE_sig_drivers_nolag.png'])
...
line(yyr,asst15(61,:),'color',csst,'Parent',h1); hold on;
line(yyr,azlos15(61,:),'color',czm,'Parent',h2); 
xlabel(h1,'Year');

line(yyr,aa_cpue97(61,:),'color','k','Parent',h3); 
ylabel(h3,'Anomalies')
title('LME 61, No lags')
print('-dpng',[ppath 'ts_LME61_CPUE_sig_drivers_nolag.png'])
