...
% 1997-2010 to comp with FEISY obsfish
...
cyr = 1997:2010; % subset effort years
...
save([fpath 'FishMIP_Phase3a_LME_Catch_1997-2010_interann_var.mat'],...
...
%%
save([fpath 'FishMIP_Phase3a_LME_Catch_1997-2010_ann_mean_anoms.mat'],...
