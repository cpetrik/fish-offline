...
%% Save climatologies
save([fpath 'cesm_fosi_v7_climatol_68yrs_natlog.mat'],'TLAT','TLONG',...
...
%
print(f3,'-dpng',[pp 'Map_FOSI_v7_MZ_clim_natlog.png'])
print(f6,'-dpng',[pp 'Map_FOSI_v7_MZloss_clim_natlog.png'])
print(f9,'-dpng',[pp 'Map_FOSI_v7_Det_clim_natlog.png'])
...
xlim([1 12])
title('Det')
print('-dpng',[pp 'ts_FOSI_v7_all_clim_natlog_gm2d.png'])
