% Table of most sig var in driver-cpue corrs
% Lag with max R2
% For all 63 LMEs
...
%%  ---------------- drivers --------------------------
load([spath,'LMEs_corr_cpue_satyrs_driver_maxcorr_posfoods.mat'])
...
%%
writetable(TabA,[spath,'Num_LMEs_corr_cpue_satyrs_driver_feisty_maxcorr_posfood_A.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabF,[spath,'Num_LMEs_corr_cpue_satyrs_driver_feisty_maxcorr_posfood_F.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabP,[spath,'Num_LMEs_corr_cpue_satyrs_driver_feisty_maxcorr_posfood_P.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(TabD,[spath,'Num_LMEs_corr_cpue_satyrs_driver_feisty_maxcorr_posfood_D.csv'],...
    'Delimiter',',','WriteRowNames',true);

save([spath,'Num_LMEs_corr_cpue_satyrs_driver_feisty_maxcorr_posfoods.mat'],...
    'matF','matP','matD','matA',...
