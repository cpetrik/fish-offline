# Heatmaps of single LR of forcing on fish "production" (nu)
# Includes 3 lags: 0,1,2
# From (2/27/2024) output
# No zmeso
# 2-4 clusters
...
fcoef <- read.csv(paste0(datar,"LME_sig_SLR_maxR2lag_driver_nu_F.csv"),sep=",",header = T,stringsAsFactors = F)
pcoef <- read.csv(paste0(datar,"LME_sig_SLR_maxR2lag_driver_nu_P.csv"),sep=",",header = T,stringsAsFactors = F)
dcoef <- read.csv(paste0(datar,"LME_sig_SLR_maxR2lag_driver_nu_D.csv"),sep=",",header = T,stringsAsFactors = F)
acoef <- read.csv(paste0(datar,"LME_sig_SLR_maxR2lag_driver_nu_A.csv"),sep=",",header = T,stringsAsFactors = F)
...
png(paste0(figp,"heatmap_LME_driver_prod_A_sig_SLR_coeffs_4clus.png"),    # create PNG for the heat map        
...
png(paste0(figp,"heatmap_LME_driver_prod_F_sig_SLR_coeffs_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"heatmap_LME_driver_prod_P_sig_SLR_coeffs_3clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
png(paste0(figp,"heatmap_LME_driver_prod_D_sig_SLR_coeffs_5clus.png"),    # create PNG for the heat map        
    width = 5*300,        # 5 x 300 pixels
    height = 6.5*300,
    res = 300,            # 300 pixels per inch
    pointsize = 8)  
...
### Save clustering
write.table(acoef,paste0(datar,"LME_driver_prod_A_sig_SLR_coeffs_cluster.csv"),sep=",",row.names=F)
write.table(fcoef,paste0(datar,"LME_driver_prod_F_sig_SLR_coeffs_cluster.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_driver_prod_P_sig_SLR_coeffs_cluster.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_driver_prod_D_sig_SLR_coeffs_cluster.csv"),sep=",",row.names=F)
