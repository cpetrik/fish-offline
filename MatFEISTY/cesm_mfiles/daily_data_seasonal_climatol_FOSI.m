...
load([fpath 'cesm_fosi_climatol_68yrs_ln.mat']);
...
save([fpath 'Data_cesm_fosi_daily_climtol_1yr.mat'], 'ESM');

%% Temp vars
CESM.Tp = tp_clim_spl;
CESM.Tb = tb_clim_spl;

save([fpath 'Data_cesm_fosi_daily_climtol_temp_1yr.mat'], 'CESM');
...
save([fpath 'Data_cesm_fosi_daily_climtol_food_1yr.mat'], 'CESM');
