...
writetable(Ftab,[rpath,'LME_corr_maxlag_driver_recruit_F.csv'],...
    'Delimiter',',');
writetable(Ptab,[rpath,'LME_corr_maxlag_driver_recruit_P.csv'],...
    'Delimiter',',');
writetable(Dtab,[rpath,'LME_corr_maxlag_driver_recruit_D.csv'],...
    'Delimiter',',');
writetable(Atab,[rpath,'LME_corr_maxlag_driver_recruit_A.csv'],...
    'Delimiter',',');

save([rpath,'LME_corr_maxlag_driver_recruit.mat'],'lid',...
