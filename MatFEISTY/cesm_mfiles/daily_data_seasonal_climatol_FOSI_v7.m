...
load([fpath 'cesm_fosi_v7_climatol_68yrs_natlog.mat']);
...
save([fpath 'Data_cesm_fosi_v7_daily_climtol_1yr.mat'], 'ESM');

%% Temp vars
CESM.Tp = tp_clim_spl;
CESM.Tb = tb_clim_spl;

save([fpath 'Data_cesm_fosi_v7_daily_climtol_temp_1yr.mat'], 'CESM');
...
save([fpath 'Data_cesm_fosi_v7_daily_climtol_food_1yr.mat'], 'CESM');
