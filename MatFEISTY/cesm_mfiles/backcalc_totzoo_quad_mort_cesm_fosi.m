...
%%
save([fpath 'g.e11_LENS.GECOIAF.T62_g16.009.meszoo_v2.mat'],...
...
zoo_quad_150m = zoo_quad_150m * 1e-9 * 1e4 * 12.01 * 9.0 * 60 * 60 * 24;
...
print('-dpng',[pp 'Map_CESM_FOSI_mean_zoo_loss_quad_v6.png'])
...
axesm ('Robinson','MapLatLimit',clatlim,'MapLonLimit',clonlim,'frame','on',...
    'Grid','off','FLineWidth',1)
surfm(TLAT,TLONG,log10(cTq))
cmocean('tempo')
caxis([-1 1])
colorbar%('Position',[0.55 0.56 0.4 0.03],'orientation','horizontal')
text(0.2,1.65,'log_1_0 TotZoo quad','HorizontalAlignment','center','FontWeight','bold')
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);
...
caxis([-1 1])
colorbar%('Position',[0.55 0.56 0.4 0.03],'orientation','horizontal')
text(0.2,1.65,'log_1_0 LgZoo quad','HorizontalAlignment','center','FontWeight','bold')
h=patchm(coastlat+0.5,coastlon+0.5,'w','FaceColor',[0.75 0.75 0.75]);

print('-dpng',[pp 'Map_CESM_FOSI_mean_zoo_quad_loss_v2_Bsplit.png'])
