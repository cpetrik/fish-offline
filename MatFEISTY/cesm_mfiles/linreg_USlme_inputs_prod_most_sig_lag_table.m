...
%%
writetable(Ftab1,[spath,'USLMEs_regress_driver_div2SD_maxcoef_Fprod.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'USLMEs_regress_driver_div2SD_maxcoef_Pprod.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'USLMEs_regress_driver_div2SD_maxcoef_Dprod.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'USLMEs_regress_driver_div2SD_maxcoef_Aprod.csv'],...
    'Delimiter',',','WriteRowNames',true);
