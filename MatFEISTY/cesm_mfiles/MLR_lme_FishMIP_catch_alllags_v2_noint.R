...
F2 <- read.csv(paste0(datap,"LMEs_FishMIP_catch_anoms_div2SD_F.csv"),sep=",",header = T,stringsAsFactors = F)
P2 <- read.csv(paste0(datap,"LMEs_FishMIP_catch_anoms_div2SD_P.csv"),sep=",",header = T,stringsAsFactors = F)
D2 <- read.csv(paste0(datap,"LMEs_FishMIP_catch_anoms_div2SD_D.csv"),sep=",",header = T,stringsAsFactors = F)
A2 <- read.csv(paste0(datap,"LMEs_FishMIP_catch_anoms_div2SD_A.csv"),sep=",",header = T,stringsAsFactors = F)
...
write.table(fcoef,paste0(datar,"LME_FishMIP_catch_F_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datar,"LME_FishMIP_catch_P_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datar,"LME_FishMIP_catch_D_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datar,"LME_FishMIP_catch_A_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)

write.table(fpval,paste0(datar,"LME_FishMIP_catch_F_mlr_pvals_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(ppval,paste0(datar,"LME_FishMIP_catch_P_mlr_pvals_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(dpval,paste0(datar,"LME_FishMIP_catch_D_mlr_pvals_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(apval,paste0(datar,"LME_FishMIP_catch_A_mlr_pvals_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)

write.table(fcoef,paste0(datap,"LME_FishMIP_catch_F_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(pcoef,paste0(datap,"LME_FishMIP_catch_P_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(dcoef,paste0(datap,"LME_FishMIP_catch_D_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
write.table(acoef,paste0(datap,"LME_FishMIP_catch_A_mlr_coeffs_ALLdiv2SD_alllags_v2_noint.csv"),sep=",",row.names=F)
