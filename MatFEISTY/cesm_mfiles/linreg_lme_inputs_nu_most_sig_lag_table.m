...
for L = 1:length(lid)
    ...
    %%
    %save([spath,ilme,'_regress_drivers_div2SD_0_5_lag_nu.mat'])
...
%%
writetable(Ftab1,[spath,'LMEs_regress_driver_div2SD_maxcoef_Fnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Ptab1,[spath,'LMEs_regress_driver_div2SD_maxcoef_Pnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Dtab1,[spath,'LMEs_regress_driver_div2SD_maxcoef_Dnu.csv'],...
    'Delimiter',',','WriteRowNames',true);
writetable(Atab1,[spath,'LMEs_regress_driver_div2SD_maxcoef_Anu.csv'],...
    'Delimiter',',','WriteRowNames',true);


save([spath,'LMEs_nu_regress_driver_div2SD_maxcoefs.mat'],...
