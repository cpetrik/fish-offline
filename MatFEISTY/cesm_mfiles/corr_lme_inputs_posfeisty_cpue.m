...
writetable(Ftab,[rpath,'LME_corr_maxlag_driver_posfeisty_cpue_F.csv'],...
    'Delimiter',',');
writetable(Ptab,[rpath,'LME_corr_maxlag_driver_posfeisty_cpue_P.csv'],...
    'Delimiter',',');
writetable(Dtab,[rpath,'LME_corr_maxlag_driver_posfeisty_cpue_D.csv'],...
    'Delimiter',',');
writetable(Atab,[rpath,'LME_corr_maxlag_driver_posfeisty_cpue_A.csv'],...
    'Delimiter',',');

save([rpath,'LME_corr_maxlag_driver_posfeisty_cpue.mat'],'lid',...
