...
%============= PARAMETER TYPE ==========%
function param = make_parameters_1meso_t1()
    ...
    param.MZ = 1;%0.9;   %Preference on one mesozooplankton group

    param.MF_phi_MZ = 1;%0.5 * param.MZ;
    param.MF_phi_S  = 1.0;

    param.MP_phi_MZ = 1;%0.5 * param.MZ;
    param.MP_phi_S  = 1.0;
