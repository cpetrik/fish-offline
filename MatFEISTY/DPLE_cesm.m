...
Member = 1; % will loop over

%! Create a directory for output
exper = ['v14_' num2str(StartYr) '_' num2str(Member) '_' ];
[fname,simname] = sub_fname_dple_exper(param,exper);
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR)
    load(['/Volumes/MIP/GCM_DATA/CESM/DPLE/Data_cesm_dple_daily_M1_Y1954_',ti,'.mat'],'ESM');
