...
function FOSI_cesm_obsfish_catch_nu()
...
file_med_f = [fname,'_catch_nu_med_f.nc'];
file_med_p = [fname,'_catch_nu_med_p.nc'];
file_med_d = [fname,'_catch_nu_med_d.nc'];
file_lrg_p = [fname,'_catch_nu_lrg_p.nc'];
file_lrg_d = [fname,'_catch_nu_lrg_d.nc'];
