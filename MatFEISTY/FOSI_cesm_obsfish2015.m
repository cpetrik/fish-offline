...
function FOSI_cesm_obsfish2015()
...
file_sml_f = [fname,'2015_sml_f.nc'];
file_sml_p = [fname,'2015_sml_p.nc'];
file_sml_d = [fname,'2015_sml_d.nc'];
file_med_f = [fname,'2015_med_f.nc'];
file_med_p = [fname,'2015_med_p.nc'];
file_med_d = [fname,'2015_med_d.nc'];
file_lrg_p = [fname,'2015_lrg_p.nc'];
file_lrg_d = [fname,'2015_lrg_d.nc'];
file_bent  = [fname,'2015_bent.nc'];
file_mzoo  = [fname,'2015_mzoo.nc'];
