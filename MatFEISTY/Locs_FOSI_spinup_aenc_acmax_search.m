...
function Locs_FOSI_spinup_aenc_acmax_search()
...
%! Load first year
load('/Volumes/petrik-lab/Feisty/GCM_DATA/CESM/FOSI/Data_cesm_fosi_v7_daily_climtol_1yr.mat','ESM');
...
for k=1:length(acp)
    for j=1:length(aep)
        ...
        [fname,simname] = sub_fname_spin_1meso(param,mod,exper);
        ...
        for YR = 1:YEARS % years
            ...
            for DAY = 1:param.DT:DAYS % days
                ...
                Spinup_LTL(DY,:,:)   = [BENT.mass BENT.pred ENVR.fZm ENVR.fB]';
                %end
