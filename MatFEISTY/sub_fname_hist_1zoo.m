%%%% File naming system
function [fname,simname] = sub_fname_hist_1zoo(frate)
...
if (frate==0)
    fname = ['/Volumes/FEISTY/NC/Matlab_new_size/',simname, '/Historic_1zoo_pristine'];
elseif (Jsel~=0.1)
    fname = ['/Volumes/FEISTY/NC/Matlab_new_size/',simname, '/Historic_1zoo_', sel,'_fish',tfish(2:end),'_Juve',tJ(2:end)];
elseif (MFsel~=LPsel)
    fname = ['/Volumes/FEISTY/NC/Matlab_new_size/',simname, '/Historic_1zoo_fish_F',tF(2:end),'_P',tP(2:end),'_D',tD(2:end)];
else
    fname  = ['/Volumes/FEISTY/NC/Matlab_new_size/',simname, '/Historic_1zoo_', sel,'_fish',tfish(2:end)];  
end
