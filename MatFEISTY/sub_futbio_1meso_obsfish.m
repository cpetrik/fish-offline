...
function [Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,ENVR] = sub_futbio_1meso_obsfish(DY,ESM,GRD,Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,param)
...
% Fishing by rate
[Sf.bio, Sf.caught, Sf.fmort] = sub_fishing_rate(Sf.bio,0,0);
[Sp.bio, Sp.caught, Sp.fmort] = sub_fishing_rate(Sp.bio,0,0);
[Sd.bio, Sd.caught, Sd.fmort] = sub_fishing_rate(Sd.bio,0,0);
