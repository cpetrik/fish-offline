...
% Just use last 300 yrs to avoid spinup portion
...
%% Biome means
sf_bio = sf_bio(:,1201:end);
sp_bio = sp_bio(:,1201:end);
sd_bio = sd_bio(:,1201:end);
mf_bio = mf_bio(:,1201:end);
mp_bio = mp_bio(:,1201:end);
md_bio = md_bio(:,1201:end);
lp_bio = lp_bio(:,1201:end);
ld_bio = ld_bio(:,1201:end);
b_bio  = b_bio(:,1201:end);
