% Distribution plots of power sepctra from PreIndust run 400 yrs
...
load('/Users/cpetrik/Dropbox/Princeton/POEM_other/grid_cobalt/hindcast_gridspec.mat',...
    'geolon_t','geolat_t');
load(['/Users/cpetrik/Dropbox/Princeton/POEM_2.0/CODE/Data/',...
    'Data_grid_hindcast_NOTflipped.mat'],'GRD');
...
%% powerspectra
load([spath 'powerspec_cobalt_pi400_ln.mat']);
load([fpath 'powerspec_feisty_stages_pi400_ln.mat']);
load([fpath 'powerspec_feisty_types_pi400_ln.mat']);
...
ylabel('PS Slope')
title('Groups')
print('-dpng',[ppath 'PI400_boxplot_ps_global.png'])
...
ylabel('PS Slope')
title('Benthic')
print('-dpng',[ppath 'PI400_boxplot_ps_global_habitat.png'])
...
ylabel('PS Slope')
title('LC Groups')
print('-dpng',[ppath 'PI400_boxplot_ps_LC.png'])
...
ylabel('PS Slope')
title('LC Benthic')
print('-dpng',[ppath 'PI400_boxplot_ps_LC_habitat.png'])
...
ylabel('PS Slope')
title('ECCS Groups')
print('-dpng',[ppath 'PI400_boxplot_ps_eccs.png'])
...
ylabel('PS Slope')
title('ECCS Benthic')
print('-dpng',[ppath 'PI400_boxplot_ps_eccs_habitat.png'])
...
ylabel('PS Slope')
title('ECSS Groups')
print('-dpng',[ppath 'PI400_boxplot_ps_ecss.png'])
...
ylabel('PS Slope')
title('ECSS Benthic')
print('-dpng',[ppath 'PI400_boxplot_ps_ecss_habitat.png'])
...
set(gca,'XTickLabel',{'F','P','D','S','M','L','All'})
ylabel('PS Slope')
title('Coastal Groups')
print('-dpng',[ppath 'PI400_boxplot_ps_coast.png'])
...
set(gca,'XTickLabel',{'TB','Det','MD','LD'})
ylabel('PS Slope')
title('Coastal Benthic')
print('-dpng',[ppath 'PI400_boxplot_ps_coast_habitat.png'])
...
boxplot(lhp_all,blab,'BoxStyle','outline','Colors','k',...
    'OutlierSize',4,'Symbol','k.')
title('LZhp')
print('-dpng',[ppath 'PI400_boxplot_ps_forcing_biome.png'])
...
boxplot(ld_all,blab,'BoxStyle','outline','Colors','k',...
    'OutlierSize',4,'Symbol','k.')
title('LD')
print('-dpng',[ppath 'PI400_boxplot_ps_stages_biome.png'])
...
print('-dpng',[ppath 'PI400_boxplot_ps_groups_biome.png'])
