...
for n = 1:12
    ...
    if(~isnan(xts(1,1)))
        ...
        %0-2 yrs
        y02 = find(yr<2);
        Fmat(1,:,n) = trapz(f1(y02),(P1(y02,:))) ./ trapz(f1,(P1))  * (1./(f1(y02(end))-f1(y02(1))));
        
        %2-5 yrs
        y25 = find(yr>=2 & yr<5);
        Fmat(2,:,n) = trapz(f1(y25),(P1(y25,:))) ./ trapz(f1,(P1))  * (1./(f1(y25(end))-f1(y25(1))));
        
        %5-12 yrs
        y512 = find(yr>=5 & yr<12);
        Fmat(3,:,n) = trapz(f1(y512),(P1(y512,:))) ./ trapz(f1,(P1))  * (1./(f1(y512(end))-f1(y512(1))));
        
        %12-20 yrs
        y1220 = find(yr>=12 & yr<20);
        Fmat(4,:,n) = trapz(f1(y1220),(P1(y1220,:))) ./ trapz(f1,(P1))  * (1./(f1(y1220(end))-f1(y1220(1))));
        
        %20-30 yrs
        y2030 = find(yr>=20 & yr<30);
        Fmat(5,:,n) = trapz(f1(y2030),(P1(y2030,:))) ./ trapz(f1,(P1))  * (1./(f1(y2030(end))-f1(y2030(1))));
        
        %30-50 yrs
        y3050 = find(yr>=30 & yr<50);
        Fmat(6,:,n) = trapz(f1(y3050),(P1(y3050,:))) ./ trapz(f1,(P1))  * (1./(f1(y3050(end))-f1(y3050(1))));
    end
...
for n = 1:12
    ...
    if(~isnan(xts(1,1)))
        ...
        %0-2 yrs
        y02 = find(yr<2);
        Dmat(1,:,n) = trapz(f1(y02),(P1(y02,:))) ./ trapz(f1,(P1))  * (1./(f1(y02(end))-f1(y02(1))));
        
        %2-5 yrs
        y25 = find(yr>=2 & yr<5);
        Dmat(2,:,n) = trapz(f1(y25),(P1(y25,:))) ./ trapz(f1,(P1))  * (1./(f1(y25(end))-f1(y25(1))));
        
        %5-12 yrs
        y512 = find(yr>=5 & yr<12);
        Dmat(3,:,n) = trapz(f1(y512),(P1(y512,:))) ./ trapz(f1,(P1))  * (1./(f1(y512(end))-f1(y512(1))));
        
        %12-20 yrs
        y1220 = find(yr>=12 & yr<20);
        Dmat(4,:,n) = trapz(f1(y1220),(P1(y1220,:))) ./ trapz(f1,(P1))  * (1./(f1(y1220(end))-f1(y1220(1))));
        
        %20-30 yrs
        y2030 = find(yr>=20 & yr<30);
        Dmat(5,:,n) = trapz(f1(y2030),(P1(y2030,:))) ./ trapz(f1,(P1))  * (1./(f1(y2030(end))-f1(y2030(1))));
        
        %30-50 yrs
        y3050 = find(yr>=30 & yr<50);
        Dmat(6,:,n) = trapz(f1(y3050),(P1(y3050,:))) ./ trapz(f1,(P1))  * (1./(f1(y3050(end))-f1(y3050(1))));
    end
...
save([fpath 'fft_trapz_pi400_cobalt_fesity_biomes_300yr_ln_v3.mat'],...
...
print('-dpng',[ppath 'Pre300_fft_trapz_bubble_biome1_v3.png'])
...
print('-dpng',[ppath 'Pre300_biomes_bubble_biome2_v3.png'])
...
print('-dpng',[ppath 'Pre300_fft_trapz_bubble_biome3_v3.png'])
...
print('-dpng',[ppath 'Pre300_fft_trapz_bubble_biome4_v3.png'])
