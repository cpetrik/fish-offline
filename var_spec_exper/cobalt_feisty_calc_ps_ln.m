...
% anomaly time series
load([spath 'cobalt_core_anom_1950_2007_ln.mat'])
[nr,nc] = size(lon);
nt = length(yid);
...
% anomaly time series
load([fpath 'feisty_core_anom_1950_2007_ln.mat'])
nt = length(yid);
...
%%
save([spath 'powerspec_cobalt_core_1950_2007_ln.mat'],...
    'tp_ps','tb_ps','det_ps',...
    'zl_ps','zm_ps','hpmz_ps','hplz_ps');

save([fpath 'powerspec_feisty_core_1950_2007_ln.mat'],...
...
title('Det')
stamp('')
print('-dpng',[ppath 'CORE_temp_det_global_ps_ln.png'])
...
title('HPloss LZ')
stamp('')
print('-dpng',[ppath 'CORE_zoo_global_ps_ln.png'])
...
print('-dpng',[ppath 'CORE_fish_groups_global_ps_ln.png'])
...
title('LZ hploss')
print('-dpng',[ppath 'CORE_histogram_phys_bgc_ps_ln.png'])
...
histogram(ld,edges)
title('LD')
print('-dpng',[ppath 'CORE_histogram_fish_stages_ps_ln.png'])
...
histogram(B,edges)
title('B')
print('-dpng',[ppath 'CORE_histogram_fish_groups_ps_ln.png'])
